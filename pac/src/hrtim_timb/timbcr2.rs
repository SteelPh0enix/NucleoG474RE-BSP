...
pub struct R(crate::R<TIMBCR2_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<TIMBCR2_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<TIMBCR2_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<TIMBCR2_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `TIMBCR2` writer"]
pub struct W(crate::W<TIMBCR2_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<TIMBCR2_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<TIMBCR2_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<TIMBCR2_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type DCDE_W<'a, const O: u8> = crate::BitWriter<'a, TIMBCR2_SPEC, O>;
...
pub type DCDS_W<'a, const O: u8> = crate::BitWriter<'a, TIMBCR2_SPEC, O>;
...
pub type OUTROM_W<'a, const O: u8> = crate::FieldWriter<'a, TIMBCR2_SPEC, 2, O>;
#[doc = "Field `ADROM` reader - ADC Roll-Over Mode"]
pub type ADROM_R = crate::FieldReader;
#[doc = "Field `ADROM` writer - ADC Roll-Over Mode"]
pub type ADROM_W<'a, const O: u8> = crate::FieldWriter<'a, TIMBCR2_SPEC, 2, O>;
...
pub type BMROM_W<'a, const O: u8> = crate::FieldWriter<'a, TIMBCR2_SPEC, 2, O>;
...
pub type FEROM_W<'a, const O: u8> = crate::FieldWriter<'a, TIMBCR2_SPEC, 2, O>;
...
pub type GTCMP1_W<'a, const O: u8> = crate::BitWriter<'a, TIMBCR2_SPEC, O>;
...
pub type GTCMP3_W<'a, const O: u8> = crate::BitWriter<'a, TIMBCR2_SPEC, O>;
#[doc = "Field `TRGHLF` reader - Triggered-half mode"]
pub type TRGHLF_R = crate::BitReader;
#[doc = "Field `TRGHLF` writer - Triggered-half mode"]
pub type TRGHLF_W<'a, const O: u8> = crate::BitWriter<'a, TIMBCR2_SPEC, O>;
impl R {
