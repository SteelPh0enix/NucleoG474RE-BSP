...
pub struct R(crate::R<CMP3BR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CMP3BR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<CMP3BR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<CMP3BR_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `CMP3BR` writer"]
pub struct W(crate::W<CMP3BR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CMP3BR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<CMP3BR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<CMP3BR_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type CMP3X_W<'a, const O: u8> = crate::FieldWriter<'a, CMP3BR_SPEC, 16, O, u16>;
impl R {
