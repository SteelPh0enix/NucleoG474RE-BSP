...
pub type DTRX_W<'a, const O: u8> = crate::FieldWriter<'a, DTBR_SPEC, 9, O, u16>;
...
pub type SDTRX_W<'a, const O: u8> = crate::BitWriter<'a, DTBR_SPEC, O>;
#[doc = "Field `DTPRSC` reader - Deadtime Prescaler"]
pub type DTPRSC_R = crate::FieldReader;
#[doc = "Field `DTPRSC` writer - Deadtime Prescaler"]
pub type DTPRSC_W<'a, const O: u8> = crate::FieldWriter<'a, DTBR_SPEC, 3, O>;
...
pub type DTRSLKX_W<'a, const O: u8> = crate::BitWriter<'a, DTBR_SPEC, O>;
...
pub type DTRLKX_W<'a, const O: u8> = crate::BitWriter<'a, DTBR_SPEC, O>;
...
pub type DTFX_W<'a, const O: u8> = crate::FieldWriter<'a, DTBR_SPEC, 9, O, u16>;
...
pub type SDTFX_W<'a, const O: u8> = crate::BitWriter<'a, DTBR_SPEC, O>;
...
pub type DTFSLKX_W<'a, const O: u8> = crate::BitWriter<'a, DTBR_SPEC, O>;
...
pub type DTFLKX_W<'a, const O: u8> = crate::BitWriter<'a, DTBR_SPEC, O>;
impl R {
