...
pub type POLYSIZE_W<'a, const O: u8> = crate::FieldWriter<'a, CR_SPEC, 2, O>;
#[doc = "Field `REV_IN` reader - Reverse input data"]
pub type REV_IN_R = crate::FieldReader;
#[doc = "Field `REV_IN` writer - Reverse input data"]
pub type REV_IN_W<'a, const O: u8> = crate::FieldWriter<'a, CR_SPEC, 2, O>;
...
pub type REV_OUT_W<'a, const O: u8> = crate::BitWriter<'a, CR_SPEC, O>;
impl R {
