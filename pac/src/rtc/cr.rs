...
pub type WCKSEL_W<'a, const O: u8> = crate::FieldWriter<'a, CR_SPEC, 3, O>;
...
pub type TSEDGE_W<'a, const O: u8> = crate::BitWriter<'a, CR_SPEC, O>;
...
pub type REFCKON_W<'a, const O: u8> = crate::BitWriter<'a, CR_SPEC, O>;
...
pub type ALRAIE_W<'a, const O: u8> = crate::BitWriter<'a, CR_SPEC, O>;
...
pub type ALRBIE_W<'a, const O: u8> = crate::BitWriter<'a, CR_SPEC, O>;
...
pub type WUTIE_W<'a, const O: u8> = crate::BitWriter<'a, CR_SPEC, O>;
...
pub type TSIE_W<'a, const O: u8> = crate::BitWriter<'a, CR_SPEC, O>;
...
pub type ADD1H_W<'a, const O: u8> = crate::BitWriter<'a, CR_SPEC, O>;
...
pub type SUB1H_W<'a, const O: u8> = crate::BitWriter<'a, CR_SPEC, O>;
#[doc = "Field `BKP` reader - Backup"]
pub type BKP_R = crate::BitReader;
#[doc = "Field `BKP` writer - Backup"]
pub type BKP_W<'a, const O: u8> = crate::BitWriter<'a, CR_SPEC, O>;
...
pub type COE_W<'a, const O: u8> = crate::BitWriter<'a, CR_SPEC, O>;
...
pub type TAMPALRM_TYPE_W<'a, const O: u8> = crate::BitWriter<'a, CR_SPEC, O>;
#[doc = "Field `OUT2EN` reader - OUT2EN"]
pub type OUT2EN_R = crate::BitReader;
#[doc = "Field `OUT2EN` writer - OUT2EN"]
pub type OUT2EN_W<'a, const O: u8> = crate::BitWriter<'a, CR_SPEC, O>;
impl R {
