...
pub type SHPF_W<'a, const O: u8> = crate::BitWriter<'a, ICSR_SPEC, O>;
...
pub type RSF_W<'a, const O: u8> = crate::BitWriter<'a, ICSR_SPEC, O>;
...
pub type INIT_W<'a, const O: u8> = crate::BitWriter<'a, ICSR_SPEC, O>;
