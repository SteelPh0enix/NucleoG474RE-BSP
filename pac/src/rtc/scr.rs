...
pub type CALRAF_W<'a, const O: u8> = crate::BitWriter<'a, SCR_SPEC, O>;
#[doc = "Field `CALRBF` writer - CALRBF"]
pub type CALRBF_W<'a, const O: u8> = crate::BitWriter<'a, SCR_SPEC, O>;
#[doc = "Field `CWUTF` writer - CWUTF"]
pub type CWUTF_W<'a, const O: u8> = crate::BitWriter<'a, SCR_SPEC, O>;
#[doc = "Field `CTSF` writer - CTSF"]
pub type CTSF_W<'a, const O: u8> = crate::BitWriter<'a, SCR_SPEC, O>;
#[doc = "Field `CTSOVF` writer - CTSOVF"]
pub type CTSOVF_W<'a, const O: u8> = crate::BitWriter<'a, SCR_SPEC, O>;
#[doc = "Field `CITSF` writer - CITSF"]
pub type CITSF_W<'a, const O: u8> = crate::BitWriter<'a, SCR_SPEC, O>;
impl W {
    #[doc = "Bit 0 - CALRAF"]
    #[inline(always)]
    #[must_use]
