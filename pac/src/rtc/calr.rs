...
pub type CALM_W<'a, const O: u8> = crate::FieldWriter<'a, CALR_SPEC, 9, O, u16>;
...
pub type CALW16_W<'a, const O: u8> = crate::BitWriter<'a, CALR_SPEC, O>;
...
pub type CALW8_W<'a, const O: u8> = crate::BitWriter<'a, CALR_SPEC, O>;
...
pub type CALP_W<'a, const O: u8> = crate::BitWriter<'a, CALR_SPEC, O>;
impl R {
