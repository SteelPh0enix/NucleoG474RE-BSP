...
pub type DU_W<'a, const O: u8> = crate::FieldWriter<'a, DR_SPEC, 4, O>;
#[doc = "Field `DT` reader - Date tens in BCD format"]
pub type DT_R = crate::FieldReader;
#[doc = "Field `DT` writer - Date tens in BCD format"]
pub type DT_W<'a, const O: u8> = crate::FieldWriter<'a, DR_SPEC, 2, O>;
