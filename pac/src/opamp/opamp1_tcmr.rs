#[doc = "Register `OPAMP1_TCMR` reader"]
pub struct R(crate::R<OPAMP1_TCMR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<OPAMP1_TCMR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<OPAMP1_TCMR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<OPAMP1_TCMR_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `OPAMP1_TCMR` writer"]
pub struct W(crate::W<OPAMP1_TCMR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<OPAMP1_TCMR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<OPAMP1_TCMR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<OPAMP1_TCMR_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "OPAMP1 control/status register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [opamp1_tcmr](index.html) module"]
pub struct OPAMP1_TCMR_SPEC;
impl crate::RegisterSpec for OPAMP1_TCMR_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [opamp1_tcmr::R](R) reader structure"]
impl crate::Readable for OPAMP1_TCMR_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [opamp1_tcmr::W](W) writer structure"]
impl crate::Writable for OPAMP1_TCMR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets OPAMP1_TCMR to value 0"]
impl crate::Resettable for OPAMP1_TCMR_SPEC {
