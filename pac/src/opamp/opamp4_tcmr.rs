#[doc = "Register `OPAMP4_TCMR` reader"]
...
#[doc = "Register `OPAMP4_TCMR` writer"]
...
#[doc = "`read()` method returns [opamp4_tcmr::R](R) reader structure"]
impl crate::Readable for OPAMP4_TCMR_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [opamp4_tcmr::W](W) writer structure"]
impl crate::Writable for OPAMP4_TCMR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets OPAMP4_TCMR to value 0"]
