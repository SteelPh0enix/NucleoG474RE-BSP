...
pub type OPAEN_W<'a, const O: u8> = crate::BitWriter<'a, OPAMP2_CSR_SPEC, O>;
...
pub type USERTRIM_W<'a, const O: u8> = crate::BitWriter<'a, OPAMP2_CSR_SPEC, O>;
...
pub type OPAHSM_W<'a, const O: u8> = crate::BitWriter<'a, OPAMP2_CSR_SPEC, O>;
#[doc = "Field `OPAINTOEN` reader - OPAINTOEN"]
pub type OPAINTOEN_R = crate::BitReader;
#[doc = "Field `OPAINTOEN` writer - OPAINTOEN"]
pub type OPAINTOEN_W<'a, const O: u8> = crate::BitWriter<'a, OPAMP2_CSR_SPEC, O>;
...
pub type CALSEL_W<'a, const O: u8> = crate::FieldWriter<'a, OPAMP2_CSR_SPEC, 2, O>;
#[doc = "Field `PGA_GAIN` reader - PGA_GAIN"]
pub type PGA_GAIN_R = crate::FieldReader;
#[doc = "Field `PGA_GAIN` writer - PGA_GAIN"]
pub type PGA_GAIN_W<'a, const O: u8> = crate::FieldWriter<'a, OPAMP2_CSR_SPEC, 5, O>;
...
pub type CALOUT_W<'a, const O: u8> = crate::BitWriter<'a, OPAMP2_CSR_SPEC, O>;
