...
pub type CTEF_W<'a, const O: u8> = crate::BitWriter<'a, FCR_SPEC, O>;
...
pub type CTCF_W<'a, const O: u8> = crate::BitWriter<'a, FCR_SPEC, O>;
...
pub type CSMF_W<'a, const O: u8> = crate::BitWriter<'a, FCR_SPEC, O>;
#[doc = "Field `CTOF` reader - Clear timeout flag"]
pub type CTOF_R = crate::BitReader;
#[doc = "Field `CTOF` writer - Clear timeout flag"]
pub type CTOF_W<'a, const O: u8> = crate::BitWriter<'a, FCR_SPEC, O>;
impl R {
