...
pub type ABMODE_W<'a, const O: u8> = crate::FieldWriter<'a, CCR_SPEC, 2, O>;
...
pub type ABSIZE_W<'a, const O: u8> = crate::FieldWriter<'a, CCR_SPEC, 2, O>;
