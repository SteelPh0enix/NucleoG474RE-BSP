...
pub type DMAREQ_ID_W<'a, const O: u8> = crate::FieldWriter<'a, C12CR_SPEC, 7, O>;
...
pub type SOIE_W<'a, const O: u8> = crate::BitWriter<'a, C12CR_SPEC, O>;
...
pub type EGE_W<'a, const O: u8> = crate::BitWriter<'a, C12CR_SPEC, O>;
...
pub type SE_W<'a, const O: u8> = crate::BitWriter<'a, C12CR_SPEC, O>;
...
pub type SPOL_W<'a, const O: u8> = crate::FieldWriter<'a, C12CR_SPEC, 2, O>;
...
pub type NBREQ_W<'a, const O: u8> = crate::FieldWriter<'a, C12CR_SPEC, 5, O>;
...
pub type SYNC_ID_W<'a, const O: u8> = crate::FieldWriter<'a, C12CR_SPEC, 5, O>;
impl R {
