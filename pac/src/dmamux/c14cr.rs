#[doc = "Register `C14CR` reader"]
pub struct R(crate::R<C14CR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<C14CR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<C14CR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<C14CR_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `C14CR` writer"]
pub struct W(crate::W<C14CR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<C14CR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<C14CR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<C14CR_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type DMAREQ_ID_W<'a, const O: u8> = crate::FieldWriter<'a, C14CR_SPEC, 7, O>;
...
pub type SOIE_W<'a, const O: u8> = crate::BitWriter<'a, C14CR_SPEC, O>;
...
pub type EGE_W<'a, const O: u8> = crate::BitWriter<'a, C14CR_SPEC, O>;
...
pub type SE_W<'a, const O: u8> = crate::BitWriter<'a, C14CR_SPEC, O>;
...
pub type SPOL_W<'a, const O: u8> = crate::FieldWriter<'a, C14CR_SPEC, 2, O>;
...
pub type NBREQ_W<'a, const O: u8> = crate::FieldWriter<'a, C14CR_SPEC, 5, O>;
...
pub type SYNC_ID_W<'a, const O: u8> = crate::FieldWriter<'a, C14CR_SPEC, 5, O>;
impl R {
...
#[doc = "DMAMux - DMA request line multiplexer channel x control register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [c14cr](index.html) module"]
pub struct C14CR_SPEC;
impl crate::RegisterSpec for C14CR_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [c14cr::R](R) reader structure"]
impl crate::Readable for C14CR_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [c14cr::W](W) writer structure"]
impl crate::Writable for C14CR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets C14CR to value 0"]
impl crate::Resettable for C14CR_SPEC {
