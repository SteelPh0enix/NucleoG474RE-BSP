...
pub type SIG_ID_W<'a, const O: u8> = crate::FieldWriter<'a, RG1CR_SPEC, 5, O>;
...
pub type OIE_W<'a, const O: u8> = crate::BitWriter<'a, RG1CR_SPEC, O>;
...
pub type GE_W<'a, const O: u8> = crate::BitWriter<'a, RG1CR_SPEC, O>;
...
pub type GPOL_W<'a, const O: u8> = crate::FieldWriter<'a, RG1CR_SPEC, 2, O>;
...
pub type GNBREQ_W<'a, const O: u8> = crate::FieldWriter<'a, RG1CR_SPEC, 5, O>;
impl R {
