...
pub type CCR5_W<'a, const O: u8> = crate::FieldWriter<'a, CCR5_SPEC, 16, O, u16>;
...
pub type GC5C1_W<'a, const O: u8> = crate::BitWriter<'a, CCR5_SPEC, O>;
...
pub type GC5C2_W<'a, const O: u8> = crate::BitWriter<'a, CCR5_SPEC, O>;
...
pub type GC5C3_W<'a, const O: u8> = crate::BitWriter<'a, CCR5_SPEC, O>;
impl R {
