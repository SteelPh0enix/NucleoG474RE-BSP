...
pub type DIR_W<'a, const O: u8> = crate::BitWriter<'a, CR1_SPEC, O>;
...
pub type CMS_W<'a, const O: u8> = crate::FieldWriter<'a, CR1_SPEC, 2, O>;
...
pub type ARPE_W<'a, const O: u8> = crate::BitWriter<'a, CR1_SPEC, O>;
#[doc = "Field `CKD` reader - Clock division"]
pub type CKD_R = crate::FieldReader;
#[doc = "Field `CKD` writer - Clock division"]
pub type CKD_W<'a, const O: u8> = crate::FieldWriter<'a, CR1_SPEC, 2, O>;
...
pub type DITHEN_W<'a, const O: u8> = crate::BitWriter<'a, CR1_SPEC, O>;
impl R {
