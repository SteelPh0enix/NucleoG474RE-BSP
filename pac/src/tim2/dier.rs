...
pub type UIE_W<'a, const O: u8> = crate::BitWriter<'a, DIER_SPEC, O>;
...
pub type CC1IE_W<'a, const O: u8> = crate::BitWriter<'a, DIER_SPEC, O>;
...
pub type CC2IE_W<'a, const O: u8> = crate::BitWriter<'a, DIER_SPEC, O>;
...
pub type CC3IE_W<'a, const O: u8> = crate::BitWriter<'a, DIER_SPEC, O>;
...
pub type CC4IE_W<'a, const O: u8> = crate::BitWriter<'a, DIER_SPEC, O>;
#[doc = "Field `COMIE` reader - COM interrupt enable"]
pub type COMIE_R = crate::BitReader;
#[doc = "Field `COMIE` writer - COM interrupt enable"]
pub type COMIE_W<'a, const O: u8> = crate::BitWriter<'a, DIER_SPEC, O>;
...
pub type BIE_W<'a, const O: u8> = crate::BitWriter<'a, DIER_SPEC, O>;
...
pub type CC1DE_W<'a, const O: u8> = crate::BitWriter<'a, DIER_SPEC, O>;
...
pub type CC2DE_W<'a, const O: u8> = crate::BitWriter<'a, DIER_SPEC, O>;
...
pub type CC3DE_W<'a, const O: u8> = crate::BitWriter<'a, DIER_SPEC, O>;
...
pub type CC4DE_W<'a, const O: u8> = crate::BitWriter<'a, DIER_SPEC, O>;
...
pub type IDXIE_W<'a, const O: u8> = crate::BitWriter<'a, DIER_SPEC, O>;
...
pub type DIRIE_W<'a, const O: u8> = crate::BitWriter<'a, DIER_SPEC, O>;
...
pub type IERRIE_W<'a, const O: u8> = crate::BitWriter<'a, DIER_SPEC, O>;
...
pub type TERRIE_W<'a, const O: u8> = crate::BitWriter<'a, DIER_SPEC, O>;
impl R {
