...
pub type UG_W<'a, const O: u8> = crate::BitWriter<'a, EGR_SPEC, O>;
#[doc = "Field `CC1G` writer - Capture/compare 1 generation"]
pub type CC1G_W<'a, const O: u8> = crate::BitWriter<'a, EGR_SPEC, O>;
#[doc = "Field `CC2G` writer - Capture/compare 2 generation"]
pub type CC2G_W<'a, const O: u8> = crate::BitWriter<'a, EGR_SPEC, O>;
#[doc = "Field `CC3G` writer - Capture/compare 3 generation"]
pub type CC3G_W<'a, const O: u8> = crate::BitWriter<'a, EGR_SPEC, O>;
#[doc = "Field `CC4G` writer - Capture/compare 4 generation"]
pub type CC4G_W<'a, const O: u8> = crate::BitWriter<'a, EGR_SPEC, O>;
#[doc = "Field `COMG` writer - Capture/Compare control update generation"]
pub type COMG_W<'a, const O: u8> = crate::BitWriter<'a, EGR_SPEC, O>;
#[doc = "Field `TG` writer - Trigger generation"]
pub type TG_W<'a, const O: u8> = crate::BitWriter<'a, EGR_SPEC, O>;
#[doc = "Field `BG` writer - Break generation"]
pub type BG_W<'a, const O: u8> = crate::BitWriter<'a, EGR_SPEC, O>;
#[doc = "Field `B2G` writer - Break 2 generation"]
pub type B2G_W<'a, const O: u8> = crate::BitWriter<'a, EGR_SPEC, O>;
impl W {
