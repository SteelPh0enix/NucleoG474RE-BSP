...
pub type CC3S_W<'a, const O: u8> = crate::FieldWriter<'a, CCMR2_INPUT_SPEC, 2, O>;
...
pub type IC3PSC_W<'a, const O: u8> = crate::FieldWriter<'a, CCMR2_INPUT_SPEC, 2, O>;
...
pub type IC3F_W<'a, const O: u8> = crate::FieldWriter<'a, CCMR2_INPUT_SPEC, 4, O>;
...
pub type CC4S_W<'a, const O: u8> = crate::FieldWriter<'a, CCMR2_INPUT_SPEC, 2, O>;
...
pub type IC4PSC_W<'a, const O: u8> = crate::FieldWriter<'a, CCMR2_INPUT_SPEC, 2, O>;
...
pub type IC4F_W<'a, const O: u8> = crate::FieldWriter<'a, CCMR2_INPUT_SPEC, 4, O>;
impl R {
