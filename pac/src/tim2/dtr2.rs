...
pub type DTGF_W<'a, const O: u8> = crate::FieldWriter<'a, DTR2_SPEC, 8, O>;
...
pub type DTAE_W<'a, const O: u8> = crate::BitWriter<'a, DTR2_SPEC, O>;
...
pub type DTPE_W<'a, const O: u8> = crate::BitWriter<'a, DTR2_SPEC, O>;
impl R {
