...
pub type CC1S_W<'a, const O: u8> = crate::FieldWriter<'a, CCMR1_INPUT_SPEC, 2, O>;
...
pub type ICPCS_W<'a, const O: u8> = crate::FieldWriter<'a, CCMR1_INPUT_SPEC, 2, O>;
...
pub type IC1F_W<'a, const O: u8> = crate::FieldWriter<'a, CCMR1_INPUT_SPEC, 4, O>;
...
pub type CC2S_W<'a, const O: u8> = crate::FieldWriter<'a, CCMR1_INPUT_SPEC, 2, O>;
...
pub type IC2F_W<'a, const O: u8> = crate::FieldWriter<'a, CCMR1_INPUT_SPEC, 4, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn icpcs(&mut self) -> ICPCS_W<2> {
        ICPCS_W::new(self)
    }
    #[doc = "Bits 4:7 - Input capture 1 filter"]
    #[inline(always)]
