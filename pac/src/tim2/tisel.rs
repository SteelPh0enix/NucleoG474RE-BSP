...
to TI1\\[15\\]
input selection"]
pub type TI1SEL_W<'a, const O: u8> = crate::FieldWriter<'a, TISEL_SPEC, 4, O>;
...
to TI2\\[15\\]
input selection"]
pub type TI2SEL_W<'a, const O: u8> = crate::FieldWriter<'a, TISEL_SPEC, 4, O>;
...
to TI3\\[15\\]
input selection"]
pub type TI3SEL_W<'a, const O: u8> = crate::FieldWriter<'a, TISEL_SPEC, 4, O>;
...
to TI4\\[15\\]
input selection"]
pub type TI4SEL_W<'a, const O: u8> = crate::FieldWriter<'a, TISEL_SPEC, 4, O>;
impl R {
    #[doc = "Bits 0:3 - TI1\\[0\\]
to TI1\\[15\\]
input selection"]
