...
pub type CCPC_W<'a, const O: u8> = crate::BitWriter<'a, CR2_SPEC, O>;
...
pub type CCUS_W<'a, const O: u8> = crate::BitWriter<'a, CR2_SPEC, O>;
...
pub type OIS4N_W<'a, const O: u8> = crate::BitWriter<'a, CR2_SPEC, O>;
...
pub type OIS5_W<'a, const O: u8> = crate::BitWriter<'a, CR2_SPEC, O>;
...
pub type OIS6_W<'a, const O: u8> = crate::BitWriter<'a, CR2_SPEC, O>;
...
pub type MMS2_W<'a, const O: u8> = crate::FieldWriter<'a, CR2_SPEC, 4, O>;
...
pub type MMS_3_W<'a, const O: u8> = crate::BitWriter<'a, CR2_SPEC, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn mms_3(&mut self) -> MMS_3_W<25> {
        MMS_3_W::new(self)
    }
