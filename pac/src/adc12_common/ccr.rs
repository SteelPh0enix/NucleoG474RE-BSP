...
pub type DUAL_W<'a, const O: u8> = crate::FieldWriter<'a, CCR_SPEC, 5, O>;
...
pub type DELAY_W<'a, const O: u8> = crate::FieldWriter<'a, CCR_SPEC, 4, O>;
...
pub type DMACFG_W<'a, const O: u8> = crate::BitWriter<'a, CCR_SPEC, O>;
