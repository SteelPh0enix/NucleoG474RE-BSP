...
pub type EA_W<'a, const O: u8> = crate::FieldWriter<'a, EP3R_SPEC, 4, O>;
#[doc = "Field `STAT_TX` reader - STAT_TX"]
pub type STAT_TX_R = crate::FieldReader;
#[doc = "Field `STAT_TX` writer - STAT_TX"]
pub type STAT_TX_W<'a, const O: u8> = crate::FieldWriter<'a, EP3R_SPEC, 2, O>;
...
pub type EP_TYPE_W<'a, const O: u8> = crate::FieldWriter<'a, EP3R_SPEC, 2, O>;
#[doc = "Field `SETUP` reader - SETUP"]
pub type SETUP_R = crate::BitReader;
#[doc = "Field `SETUP` writer - SETUP"]
pub type SETUP_W<'a, const O: u8> = crate::BitWriter<'a, EP3R_SPEC, O>;
#[doc = "Field `STAT_RX` reader - STAT_RX"]
pub type STAT_RX_R = crate::FieldReader;
#[doc = "Field `STAT_RX` writer - STAT_RX"]
pub type STAT_RX_W<'a, const O: u8> = crate::FieldWriter<'a, EP3R_SPEC, 2, O>;
