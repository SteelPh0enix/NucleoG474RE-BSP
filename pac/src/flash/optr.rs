...
pub type IDWG_SW_W<'a, const O: u8> = crate::BitWriter<'a, OPTR_SPEC, O>;
...
pub type IWDG_STOP_W<'a, const O: u8> = crate::BitWriter<'a, OPTR_SPEC, O>;
...
pub type IWDG_STDBY_W<'a, const O: u8> = crate::BitWriter<'a, OPTR_SPEC, O>;
...
pub type WWDG_SW_W<'a, const O: u8> = crate::BitWriter<'a, OPTR_SPEC, O>;
#[doc = "Field `nBOOT1` reader - Boot configuration"]
pub type N_BOOT1_R = crate::BitReader;
#[doc = "Field `nBOOT1` writer - Boot configuration"]
pub type N_BOOT1_W<'a, const O: u8> = crate::BitWriter<'a, OPTR_SPEC, O>;
...
pub type SRAM2_PE_W<'a, const O: u8> = crate::BitWriter<'a, OPTR_SPEC, O>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn nrst_mode(&mut self) -> NRST_MODE_W<28> {
        NRST_MODE_W::new(self)
    }
    #[doc = "Bit 30 - IRHEN"]
    #[inline(always)]
    #[must_use]
    pub fn irhen(&mut self) -> IRHEN_W<30> {
        IRHEN_W::new(self)
    }
