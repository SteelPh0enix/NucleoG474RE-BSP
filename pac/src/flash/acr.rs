...
pub type LATENCY_W<'a, const O: u8> = crate::FieldWriter<'a, ACR_SPEC, 4, O>;
#[doc = "Field `PRFTEN` reader - Prefetch enable"]
pub type PRFTEN_R = crate::BitReader;
#[doc = "Field `PRFTEN` writer - Prefetch enable"]
pub type PRFTEN_W<'a, const O: u8> = crate::BitWriter<'a, ACR_SPEC, O>;
...
pub type ICEN_W<'a, const O: u8> = crate::BitWriter<'a, ACR_SPEC, O>;
#[doc = "Field `DCEN` reader - Data cache enable"]
pub type DCEN_R = crate::BitReader;
#[doc = "Field `DCEN` writer - Data cache enable"]
pub type DCEN_W<'a, const O: u8> = crate::BitWriter<'a, ACR_SPEC, O>;
...
pub type ICRST_W<'a, const O: u8> = crate::BitWriter<'a, ACR_SPEC, O>;
#[doc = "Field `DCRST` reader - Data cache reset"]
pub type DCRST_R = crate::BitReader;
#[doc = "Field `DCRST` writer - Data cache reset"]
pub type DCRST_W<'a, const O: u8> = crate::BitWriter<'a, ACR_SPEC, O>;
...
pub type RUN_PD_W<'a, const O: u8> = crate::BitWriter<'a, ACR_SPEC, O>;
...
pub type SLEEP_PD_W<'a, const O: u8> = crate::BitWriter<'a, ACR_SPEC, O>;
...
pub type DBG_SWEN_W<'a, const O: u8> = crate::BitWriter<'a, ACR_SPEC, O>;
impl R {
