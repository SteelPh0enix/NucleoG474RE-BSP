...
pub type DSJW_W<'a, const O: u8> = crate::FieldWriter<'a, FDCAN_DBTP_SPEC, 4, O>;
...
pub type DTSEG2_W<'a, const O: u8> = crate::FieldWriter<'a, FDCAN_DBTP_SPEC, 4, O>;
...
pub type DTSEG1_W<'a, const O: u8> = crate::FieldWriter<'a, FDCAN_DBTP_SPEC, 5, O>;
...
pub type DBRP_W<'a, const O: u8> = crate::FieldWriter<'a, FDCAN_DBTP_SPEC, 5, O>;
...
pub type TDC_W<'a, const O: u8> = crate::BitWriter<'a, FDCAN_DBTP_SPEC, O, TDC_A>;
