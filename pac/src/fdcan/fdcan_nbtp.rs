...
pub type NTSEG2_W<'a, const O: u8> = crate::FieldWriter<'a, FDCAN_NBTP_SPEC, 7, O>;
...
and bit 0 \\[INIT\\]
of CCCR register are set to 1."]
pub type NTSEG1_W<'a, const O: u8> = crate::FieldWriter<'a, FDCAN_NBTP_SPEC, 8, O>;
...
and bit 0 \\[INIT\\]
of CCCR register are set to 1."]
pub type NBRP_W<'a, const O: u8> = crate::FieldWriter<'a, FDCAN_NBTP_SPEC, 9, O, u16>;
...
and bit 0 \\[INIT\\]
of CCCR register are set to 1."]
pub type NSJW_W<'a, const O: u8> = crate::FieldWriter<'a, FDCAN_NBTP_SPEC, 7, O>;
impl R {
