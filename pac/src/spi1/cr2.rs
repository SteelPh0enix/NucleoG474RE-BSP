...
pub type RXDMAEN_W<'a, const O: u8> = crate::BitWriter<'a, CR2_SPEC, O>;
...
pub type RXNEIE_W<'a, const O: u8> = crate::BitWriter<'a, CR2_SPEC, O>;
...
pub type TXEIE_W<'a, const O: u8> = crate::BitWriter<'a, CR2_SPEC, O>;
#[doc = "Field `DS` reader - Data size"]
pub type DS_R = crate::FieldReader;
#[doc = "Field `DS` writer - Data size"]
pub type DS_W<'a, const O: u8> = crate::FieldWriter<'a, CR2_SPEC, 4, O>;
...
pub type FRXTH_W<'a, const O: u8> = crate::BitWriter<'a, CR2_SPEC, O>;
...
pub type LDMA_RX_W<'a, const O: u8> = crate::BitWriter<'a, CR2_SPEC, O>;
...
pub type LDMA_TX_W<'a, const O: u8> = crate::BitWriter<'a, CR2_SPEC, O>;
impl R {
