...
pub struct R(crate::R<DTFR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<DTFR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<DTFR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<DTFR_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `DTFR` writer"]
pub struct W(crate::W<DTFR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<DTFR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<DTFR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<DTFR_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type DTRX_W<'a, const O: u8> = crate::FieldWriter<'a, DTFR_SPEC, 9, O, u16>;
...
pub type SDTRX_W<'a, const O: u8> = crate::BitWriter<'a, DTFR_SPEC, O>;
#[doc = "Field `DTPRSC` reader - Deadtime Prescaler"]
pub type DTPRSC_R = crate::FieldReader;
#[doc = "Field `DTPRSC` writer - Deadtime Prescaler"]
pub type DTPRSC_W<'a, const O: u8> = crate::FieldWriter<'a, DTFR_SPEC, 3, O>;
...
pub type DTRSLKX_W<'a, const O: u8> = crate::BitWriter<'a, DTFR_SPEC, O>;
...
pub type DTRLKX_W<'a, const O: u8> = crate::BitWriter<'a, DTFR_SPEC, O>;
...
pub type DTFX_W<'a, const O: u8> = crate::FieldWriter<'a, DTFR_SPEC, 9, O, u16>;
...
pub type SDTFX_W<'a, const O: u8> = crate::BitWriter<'a, DTFR_SPEC, O>;
...
pub type DTFSLKX_W<'a, const O: u8> = crate::BitWriter<'a, DTFR_SPEC, O>;
...
pub type DTFLKX_W<'a, const O: u8> = crate::BitWriter<'a, DTFR_SPEC, O>;
impl R {
