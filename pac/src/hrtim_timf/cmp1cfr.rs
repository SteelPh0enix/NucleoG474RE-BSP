...
pub struct R(crate::R<CMP1CFR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CMP1CFR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<CMP1CFR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<CMP1CFR_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `CMP1CFR` writer"]
pub struct W(crate::W<CMP1CFR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CMP1CFR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<CMP1CFR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<CMP1CFR_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type CMP1X_W<'a, const O: u8> = crate::FieldWriter<'a, CMP1CFR_SPEC, 16, O, u16>;
...
pub type REPX_W<'a, const O: u8> = crate::FieldWriter<'a, CMP1CFR_SPEC, 8, O>;
impl R {
