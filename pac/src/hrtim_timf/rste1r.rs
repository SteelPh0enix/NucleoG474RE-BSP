...
#[doc = "`read()` method returns [rste1r::R](R) reader structure"]
impl crate::Readable for RSTE1R_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [rste1r::W](W) writer structure"]
impl crate::Writable for RSTE1R_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets RSTE1R to value 0"]
