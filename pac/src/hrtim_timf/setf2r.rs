#[doc = "Register `SETF2R` reader"]
pub struct R(crate::R<SETF2R_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<SETF2R_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<SETF2R_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<SETF2R_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `SETF2R` writer"]
pub struct W(crate::W<SETF2R_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<SETF2R_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<SETF2R_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<SETF2R_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "Timerx Output2 Set Register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [setf2r](index.html) module"]
pub struct SETF2R_SPEC;
impl crate::RegisterSpec for SETF2R_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [setf2r::R](R) reader structure"]
impl crate::Readable for SETF2R_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [setf2r::W](W) writer structure"]
impl crate::Writable for SETF2R_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets SETF2R to value 0"]
impl crate::Resettable for SETF2R_SPEC {
