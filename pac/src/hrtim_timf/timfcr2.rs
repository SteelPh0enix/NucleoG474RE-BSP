#[doc = "Register `TIMFCR2` reader"]
pub struct R(crate::R<TIMFCR2_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<TIMFCR2_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<TIMFCR2_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<TIMFCR2_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `TIMFCR2` writer"]
pub struct W(crate::W<TIMFCR2_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<TIMFCR2_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<TIMFCR2_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<TIMFCR2_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type DCDE_W<'a, const O: u8> = crate::BitWriter<'a, TIMFCR2_SPEC, O>;
...
pub type DCDS_W<'a, const O: u8> = crate::BitWriter<'a, TIMFCR2_SPEC, O>;
...
pub type OUTROM_W<'a, const O: u8> = crate::FieldWriter<'a, TIMFCR2_SPEC, 2, O>;
#[doc = "Field `ADROM` reader - ADC Roll-Over Mode"]
pub type ADROM_R = crate::FieldReader;
#[doc = "Field `ADROM` writer - ADC Roll-Over Mode"]
pub type ADROM_W<'a, const O: u8> = crate::FieldWriter<'a, TIMFCR2_SPEC, 2, O>;
...
pub type BMROM_W<'a, const O: u8> = crate::FieldWriter<'a, TIMFCR2_SPEC, 2, O>;
...
pub type FEROM_W<'a, const O: u8> = crate::FieldWriter<'a, TIMFCR2_SPEC, 2, O>;
...
pub type GTCMP1_W<'a, const O: u8> = crate::BitWriter<'a, TIMFCR2_SPEC, O>;
...
pub type GTCMP3_W<'a, const O: u8> = crate::BitWriter<'a, TIMFCR2_SPEC, O>;
#[doc = "Field `TRGHLF` reader - Triggered-half mode"]
pub type TRGHLF_R = crate::BitReader;
#[doc = "Field `TRGHLF` writer - Triggered-half mode"]
pub type TRGHLF_W<'a, const O: u8> = crate::BitWriter<'a, TIMFCR2_SPEC, O>;
impl R {
...
#[doc = "HRTIM Timerx Control Register 2\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [timfcr2](index.html) module"]
pub struct TIMFCR2_SPEC;
impl crate::RegisterSpec for TIMFCR2_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [timfcr2::R](R) reader structure"]
impl crate::Readable for TIMFCR2_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [timfcr2::W](W) writer structure"]
impl crate::Writable for TIMFCR2_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets TIMFCR2 to value 0"]
impl crate::Resettable for TIMFCR2_SPEC {
