...
pub type PSHPLL_W<'a, const O: u8> = crate::BitWriter<'a, TIMFCR_SPEC, O>;
#[doc = "Field `INTLVD` reader - Interleaved mode"]
pub type INTLVD_R = crate::FieldReader;
#[doc = "Field `INTLVD` writer - Interleaved mode"]
pub type INTLVD_W<'a, const O: u8> = crate::FieldWriter<'a, TIMFCR_SPEC, 2, O>;
...
pub type RSYNCU_W<'a, const O: u8> = crate::BitWriter<'a, TIMFCR_SPEC, O>;
...
pub type SYNCRSTX_W<'a, const O: u8> = crate::BitWriter<'a, TIMFCR_SPEC, O>;
