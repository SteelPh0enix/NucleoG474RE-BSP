...
pub type SST_W<'a, const O: u8> = crate::BitWriter<'a, SETF1R_SPEC, O>;
...
pub type EXTEVNT10_W<'a, const O: u8> = crate::BitWriter<'a, SETF1R_SPEC, O>;
...
pub type UPDATE_W<'a, const O: u8> = crate::BitWriter<'a, SETF1R_SPEC, O>;
impl R {
