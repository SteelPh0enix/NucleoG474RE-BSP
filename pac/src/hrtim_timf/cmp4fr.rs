...
pub type CMP4X_W<'a, const O: u8> = crate::FieldWriter<'a, CMP4FR_SPEC, 16, O, u16>;
impl R {
...
#[doc = "`read()` method returns [cmp4fr::R](R) reader structure"]
impl crate::Readable for CMP4FR_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [cmp4fr::W](W) writer structure"]
impl crate::Writable for CMP4FR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets CMP4FR to value 0"]
