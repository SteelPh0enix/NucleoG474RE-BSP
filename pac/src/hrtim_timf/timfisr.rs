...
pub struct R(crate::R<TIMFISR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<TIMFISR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<TIMFISR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<TIMFISR_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "Timerx Interrupt Status Register\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [timfisr](index.html) module"]
pub struct TIMFISR_SPEC;
impl crate::RegisterSpec for TIMFISR_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [timfisr::R](R) reader structure"]
impl crate::Readable for TIMFISR_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets TIMFISR to value 0"]
impl crate::Resettable for TIMFISR_SPEC {
