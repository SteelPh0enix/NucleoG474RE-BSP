#[doc = "Register `EEFFR1` reader"]
pub struct R(crate::R<EEFFR1_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<EEFFR1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<EEFFR1_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<EEFFR1_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `EEFFR1` writer"]
pub struct W(crate::W<EEFFR1_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<EEFFR1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<EEFFR1_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<EEFFR1_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type EE1LTCH_W<'a, const O: u8> = crate::BitWriter<'a, EEFFR1_SPEC, O>;
...
pub type EE1FLTR_W<'a, const O: u8> = crate::FieldWriter<'a, EEFFR1_SPEC, 4, O>;
...
pub type EE2LTCH_W<'a, const O: u8> = crate::BitWriter<'a, EEFFR1_SPEC, O>;
...
pub type EE2FLTR_W<'a, const O: u8> = crate::FieldWriter<'a, EEFFR1_SPEC, 4, O>;
...
pub type EE3LTCH_W<'a, const O: u8> = crate::BitWriter<'a, EEFFR1_SPEC, O>;
...
pub type EE3FLTR_W<'a, const O: u8> = crate::FieldWriter<'a, EEFFR1_SPEC, 4, O>;
...
pub type EE4LTCH_W<'a, const O: u8> = crate::BitWriter<'a, EEFFR1_SPEC, O>;
...
pub type EE4FLTR_W<'a, const O: u8> = crate::FieldWriter<'a, EEFFR1_SPEC, 4, O>;
...
pub type EE5LTCH_W<'a, const O: u8> = crate::BitWriter<'a, EEFFR1_SPEC, O>;
...
pub type EE5FLTR_W<'a, const O: u8> = crate::FieldWriter<'a, EEFFR1_SPEC, 4, O>;
impl R {
...
#[doc = "Timerx External Event Filtering Register 1\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [eeffr1](index.html) module"]
pub struct EEFFR1_SPEC;
impl crate::RegisterSpec for EEFFR1_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [eeffr1::R](R) reader structure"]
impl crate::Readable for EEFFR1_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [eeffr1::W](W) writer structure"]
impl crate::Writable for EEFFR1_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets EEFFR1 to value 0"]
impl crate::Resettable for EEFFR1_SPEC {
