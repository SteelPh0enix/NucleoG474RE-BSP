...
pub type SYNCOKC_W<'a, const O: u8> = crate::BitWriter<'a, ICR_SPEC, O>;
...
pub type SYNCWARNC_W<'a, const O: u8> = crate::BitWriter<'a, ICR_SPEC, O>;
...
pub type ERRC_W<'a, const O: u8> = crate::BitWriter<'a, ICR_SPEC, O>;
...
pub type ESYNCC_W<'a, const O: u8> = crate::BitWriter<'a, ICR_SPEC, O>;
impl R {
