...
pub type SYNCOKIE_W<'a, const O: u8> = crate::BitWriter<'a, CR_SPEC, O>;
...
pub type SYNCWARNIE_W<'a, const O: u8> = crate::BitWriter<'a, CR_SPEC, O>;
...
pub type ESYNCIE_W<'a, const O: u8> = crate::BitWriter<'a, CR_SPEC, O>;
...
pub type CEN_W<'a, const O: u8> = crate::BitWriter<'a, CR_SPEC, O>;
...
pub type AUTOTRIMEN_W<'a, const O: u8> = crate::BitWriter<'a, CR_SPEC, O>;
...
pub type SWSYNC_W<'a, const O: u8> = crate::BitWriter<'a, CR_SPEC, O>;
...
pub type TRIM_W<'a, const O: u8> = crate::FieldWriter<'a, CR_SPEC, 7, O>;
impl R {
