...
pub type RELOAD_W<'a, const O: u8> = crate::FieldWriter<'a, CFGR_SPEC, 16, O, u16>;
...
bits of the CRS_ISR register. Refer to Section7.3.4: Frequency error evaluation and automatic trimming for more details about FECAP evaluation."]
pub type FELIM_W<'a, const O: u8> = crate::FieldWriter<'a, CFGR_SPEC, 8, O>;
...
pub type SYNCDIV_W<'a, const O: u8> = crate::FieldWriter<'a, CFGR_SPEC, 3, O>;
...
pub type SYNCSRC_W<'a, const O: u8> = crate::FieldWriter<'a, CFGR_SPEC, 2, O>;
...
pub type SYNCPOL_W<'a, const O: u8> = crate::BitWriter<'a, CFGR_SPEC, O>;
impl R {
