...
pub type TYPEC_VSTATE_CC1_W<'a, const O: u8> = crate::FieldWriter<'a, SR_SPEC, 2, O>;
...
pub type TYPEC_VSTATE_CC2_W<'a, const O: u8> = crate::FieldWriter<'a, SR_SPEC, 2, O>;
#[doc = "Field `FRSEVT` reader - FRSEVT"]
pub type FRSEVT_R = crate::BitReader;
#[doc = "Field `FRSEVT` writer - FRSEVT"]
pub type FRSEVT_W<'a, const O: u8> = crate::BitWriter<'a, SR_SPEC, O>;
impl R {
    #[doc = "Bit 0 - TXIS"]
    #[inline(always)]
