...
pub type SWCPT_W<'a, const O: u8> = crate::BitWriter<'a, CPT2CCR_SPEC, O>;
#[doc = "Field `UDPCPT` reader - Update Capture"]
pub type UDPCPT_R = crate::BitReader;
#[doc = "Field `UDPCPT` writer - Update Capture"]
pub type UDPCPT_W<'a, const O: u8> = crate::BitWriter<'a, CPT2CCR_SPEC, O>;
...
pub type EXEV1CPT_W<'a, const O: u8> = crate::BitWriter<'a, CPT2CCR_SPEC, O>;
...
pub type EXEV2CPT_W<'a, const O: u8> = crate::BitWriter<'a, CPT2CCR_SPEC, O>;
...
pub type EXEV3CPT_W<'a, const O: u8> = crate::BitWriter<'a, CPT2CCR_SPEC, O>;
...
pub type EXEV4CPT_W<'a, const O: u8> = crate::BitWriter<'a, CPT2CCR_SPEC, O>;
...
pub type EXEV5CPT_W<'a, const O: u8> = crate::BitWriter<'a, CPT2CCR_SPEC, O>;
...
pub type EXEV6CPT_W<'a, const O: u8> = crate::BitWriter<'a, CPT2CCR_SPEC, O>;
...
pub type EXEV7CPT_W<'a, const O: u8> = crate::BitWriter<'a, CPT2CCR_SPEC, O>;
...
pub type EXEV8CPT_W<'a, const O: u8> = crate::BitWriter<'a, CPT2CCR_SPEC, O>;
...
pub type EXEV9CPT_W<'a, const O: u8> = crate::BitWriter<'a, CPT2CCR_SPEC, O>;
...
pub type EXEV10CPT_W<'a, const O: u8> = crate::BitWriter<'a, CPT2CCR_SPEC, O>;
...
pub type TA1SET_W<'a, const O: u8> = crate::BitWriter<'a, CPT2CCR_SPEC, O>;
...
pub type TB1SET_W<'a, const O: u8> = crate::BitWriter<'a, CPT2CCR_SPEC, O>;
...
pub type TD1SET_W<'a, const O: u8> = crate::BitWriter<'a, CPT2CCR_SPEC, O>;
...
pub type TE1SET_W<'a, const O: u8> = crate::BitWriter<'a, CPT2CCR_SPEC, O>;
...
impl R {
    ...
    pub fn tf1cmp1(&self) -> TF1CMP1_R {
        TF1CMP1_R::new(((self.bits >> 22) & 1) != 0)
    }
    #[doc = "Bit 23 - TF1CMP2"]
    #[inline(always)]
    pub fn tf1cmp2(&self) -> TF1CMP2_R {
        TF1CMP2_R::new(((self.bits >> 23) & 1) != 0)
    }
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn tf1cmp1(&mut self) -> TF1CMP1_W<22> {
        TF1CMP1_W::new(self)
    }
    #[doc = "Bit 23 - TF1CMP2"]
    #[inline(always)]
    #[must_use]
    pub fn tf1cmp2(&mut self) -> TF1CMP2_W<23> {
        TF1CMP2_W::new(self)
    }
    #[doc = "Bit 24 - Timer D output 1 Set"]
    #[inline(always)]
