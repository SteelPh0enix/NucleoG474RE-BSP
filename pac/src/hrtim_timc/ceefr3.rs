...
pub type EEVACE_W<'a, const O: u8> = crate::BitWriter<'a, CEEFR3_SPEC, O>;
...
pub type EEVACRES_W<'a, const O: u8> = crate::BitWriter<'a, CEEFR3_SPEC, O>;
...
pub type EEVARSTM_W<'a, const O: u8> = crate::BitWriter<'a, CEEFR3_SPEC, O>;
...
pub type EEVASEL_W<'a, const O: u8> = crate::FieldWriter<'a, CEEFR3_SPEC, 4, O>;
...
pub type EEVACNT_W<'a, const O: u8> = crate::FieldWriter<'a, CEEFR3_SPEC, 6, O>;
impl R {
...
#[doc = "`read()` method returns [ceefr3::R](R) reader structure"]
impl crate::Readable for CEEFR3_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [ceefr3::W](W) writer structure"]
impl crate::Writable for CEEFR3_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets CEEFR3 to value 0"]
