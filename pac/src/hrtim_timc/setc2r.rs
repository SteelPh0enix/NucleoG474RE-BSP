...
#[doc = "`read()` method returns [setc2r::R](R) reader structure"]
impl crate::Readable for SETC2R_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [setc2r::W](W) writer structure"]
impl crate::Writable for SETC2R_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets SETC2R to value 0"]
