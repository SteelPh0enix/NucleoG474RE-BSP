...
pub struct R(crate::R<CPT1CCR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CPT1CCR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<CPT1CCR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<CPT1CCR_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `CPT1CCR` writer"]
pub struct W(crate::W<CPT1CCR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CPT1CCR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<CPT1CCR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<CPT1CCR_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type SWCPT_W<'a, const O: u8> = crate::BitWriter<'a, CPT1CCR_SPEC, O>;
#[doc = "Field `UDPCPT` reader - Update Capture"]
pub type UDPCPT_R = crate::BitReader;
#[doc = "Field `UDPCPT` writer - Update Capture"]
pub type UDPCPT_W<'a, const O: u8> = crate::BitWriter<'a, CPT1CCR_SPEC, O>;
...
pub type EXEV1CPT_W<'a, const O: u8> = crate::BitWriter<'a, CPT1CCR_SPEC, O>;
...
pub type EXEV2CPT_W<'a, const O: u8> = crate::BitWriter<'a, CPT1CCR_SPEC, O>;
...
pub type EXEV3CPT_W<'a, const O: u8> = crate::BitWriter<'a, CPT1CCR_SPEC, O>;
...
pub type EXEV4CPT_W<'a, const O: u8> = crate::BitWriter<'a, CPT1CCR_SPEC, O>;
...
pub type EXEV5CPT_W<'a, const O: u8> = crate::BitWriter<'a, CPT1CCR_SPEC, O>;
...
pub type EXEV6CPT_W<'a, const O: u8> = crate::BitWriter<'a, CPT1CCR_SPEC, O>;
...
pub type EXEV7CPT_W<'a, const O: u8> = crate::BitWriter<'a, CPT1CCR_SPEC, O>;
...
pub type EXEV8CPT_W<'a, const O: u8> = crate::BitWriter<'a, CPT1CCR_SPEC, O>;
...
pub type EXEV9CPT_W<'a, const O: u8> = crate::BitWriter<'a, CPT1CCR_SPEC, O>;
...
pub type EXEV10CPT_W<'a, const O: u8> = crate::BitWriter<'a, CPT1CCR_SPEC, O>;
...
pub type TA1SET_W<'a, const O: u8> = crate::BitWriter<'a, CPT1CCR_SPEC, O>;
...
pub type TB1SET_W<'a, const O: u8> = crate::BitWriter<'a, CPT1CCR_SPEC, O>;
...
pub type TD1SET_W<'a, const O: u8> = crate::BitWriter<'a, CPT1CCR_SPEC, O>;
...
pub type TE1SET_W<'a, const O: u8> = crate::BitWriter<'a, CPT1CCR_SPEC, O>;
...
impl R {
    ...
    pub fn tf1set(&self) -> TF1SET_R {
        TF1SET_R::new(((self.bits >> 20) & 1) != 0)
    }
    #[doc = "Bit 21 - TF1RST"]
    #[inline(always)]
    pub fn tf1rst(&self) -> TF1RST_R {
        TF1RST_R::new(((self.bits >> 21) & 1) != 0)
    }
    #[doc = "Bit 22 - TFCMP1"]
    #[inline(always)]
    pub fn tfcmp1(&self) -> TFCMP1_R {
        TFCMP1_R::new(((self.bits >> 22) & 1) != 0)
    }
    #[doc = "Bit 23 - TFCMP2"]
    #[inline(always)]
    pub fn tfcmp2(&self) -> TFCMP2_R {
        TFCMP2_R::new(((self.bits >> 23) & 1) != 0)
    }
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn tf1set(&mut self) -> TF1SET_W<20> {
        TF1SET_W::new(self)
    }
    #[doc = "Bit 21 - TF1RST"]
    #[inline(always)]
    #[must_use]
    pub fn tf1rst(&mut self) -> TF1RST_W<21> {
        TF1RST_W::new(self)
    }
    #[doc = "Bit 22 - TFCMP1"]
    #[inline(always)]
    #[must_use]
    pub fn tfcmp1(&mut self) -> TFCMP1_W<22> {
        TFCMP1_W::new(self)
    }
    #[doc = "Bit 23 - TFCMP2"]
    #[inline(always)]
    #[must_use]
    pub fn tfcmp2(&mut self) -> TFCMP2_W<23> {
        TFCMP2_W::new(self)
    }
    #[doc = "Bit 24 - Timer D output 1 Set"]
    #[inline(always)]
