...
pub type CMP1C_W<'a, const O: u8> = crate::BitWriter<'a, TIMEICR_SPEC, O>;
#[doc = "Field `CMP2C` writer - Compare 2 Interrupt flag Clear"]
pub type CMP2C_W<'a, const O: u8> = crate::BitWriter<'a, TIMEICR_SPEC, O>;
#[doc = "Field `CMP3C` writer - Compare 3 Interrupt flag Clear"]
pub type CMP3C_W<'a, const O: u8> = crate::BitWriter<'a, TIMEICR_SPEC, O>;
#[doc = "Field `CMP4C` writer - Compare 4 Interrupt flag Clear"]
pub type CMP4C_W<'a, const O: u8> = crate::BitWriter<'a, TIMEICR_SPEC, O>;
#[doc = "Field `REPC` writer - Repetition Interrupt flag Clear"]
pub type REPC_W<'a, const O: u8> = crate::BitWriter<'a, TIMEICR_SPEC, O>;
#[doc = "Field `UPDC` writer - Update Interrupt flag Clear"]
pub type UPDC_W<'a, const O: u8> = crate::BitWriter<'a, TIMEICR_SPEC, O>;
#[doc = "Field `CPT1C` writer - Capture1 Interrupt flag Clear"]
pub type CPT1C_W<'a, const O: u8> = crate::BitWriter<'a, TIMEICR_SPEC, O>;
#[doc = "Field `CPT2C` writer - Capture2 Interrupt flag Clear"]
pub type CPT2C_W<'a, const O: u8> = crate::BitWriter<'a, TIMEICR_SPEC, O>;
#[doc = "Field `SET1xC` writer - Output 1 Set flag Clear"]
pub type SET1X_C_W<'a, const O: u8> = crate::BitWriter<'a, TIMEICR_SPEC, O>;
#[doc = "Field `RSTx1C` writer - Output 1 Reset flag Clear"]
pub type RSTX1C_W<'a, const O: u8> = crate::BitWriter<'a, TIMEICR_SPEC, O>;
#[doc = "Field `SET2xC` writer - Output 2 Set flag Clear"]
pub type SET2X_C_W<'a, const O: u8> = crate::BitWriter<'a, TIMEICR_SPEC, O>;
#[doc = "Field `RSTx2C` writer - Output 2 Reset flag Clear"]
pub type RSTX2C_W<'a, const O: u8> = crate::BitWriter<'a, TIMEICR_SPEC, O>;
#[doc = "Field `RSTC` writer - Reset Interrupt flag Clear"]
pub type RSTC_W<'a, const O: u8> = crate::BitWriter<'a, TIMEICR_SPEC, O>;
#[doc = "Field `DLYPRTC` writer - Delayed Protection Flag Clear"]
pub type DLYPRTC_W<'a, const O: u8> = crate::BitWriter<'a, TIMEICR_SPEC, O>;
impl W {
