...
pub type EE1LTCH_W<'a, const O: u8> = crate::BitWriter<'a, EEFER1_SPEC, O>;
...
pub type EE1FLTR_W<'a, const O: u8> = crate::FieldWriter<'a, EEFER1_SPEC, 4, O>;
...
pub type EE2LTCH_W<'a, const O: u8> = crate::BitWriter<'a, EEFER1_SPEC, O>;
...
pub type EE2FLTR_W<'a, const O: u8> = crate::FieldWriter<'a, EEFER1_SPEC, 4, O>;
...
pub type EE3LTCH_W<'a, const O: u8> = crate::BitWriter<'a, EEFER1_SPEC, O>;
...
pub type EE3FLTR_W<'a, const O: u8> = crate::FieldWriter<'a, EEFER1_SPEC, 4, O>;
...
pub type EE4LTCH_W<'a, const O: u8> = crate::BitWriter<'a, EEFER1_SPEC, O>;
...
pub type EE4FLTR_W<'a, const O: u8> = crate::FieldWriter<'a, EEFER1_SPEC, 4, O>;
...
pub type EE5LTCH_W<'a, const O: u8> = crate::BitWriter<'a, EEFER1_SPEC, O>;
...
pub type EE5FLTR_W<'a, const O: u8> = crate::FieldWriter<'a, EEFER1_SPEC, 4, O>;
impl R {
