...
pub type SWCPT_W<'a, const O: u8> = crate::BitWriter<'a, CPT2ECR_SPEC, O>;
#[doc = "Field `UDPCPT` reader - Update Capture"]
pub type UDPCPT_R = crate::BitReader;
#[doc = "Field `UDPCPT` writer - Update Capture"]
pub type UDPCPT_W<'a, const O: u8> = crate::BitWriter<'a, CPT2ECR_SPEC, O>;
...
pub type EXEV1CPT_W<'a, const O: u8> = crate::BitWriter<'a, CPT2ECR_SPEC, O>;
...
pub type EXEV2CPT_W<'a, const O: u8> = crate::BitWriter<'a, CPT2ECR_SPEC, O>;
...
pub type EXEV3CPT_W<'a, const O: u8> = crate::BitWriter<'a, CPT2ECR_SPEC, O>;
...
pub type EXEV4CPT_W<'a, const O: u8> = crate::BitWriter<'a, CPT2ECR_SPEC, O>;
...
pub type EXEV5CPT_W<'a, const O: u8> = crate::BitWriter<'a, CPT2ECR_SPEC, O>;
...
pub type EXEV6CPT_W<'a, const O: u8> = crate::BitWriter<'a, CPT2ECR_SPEC, O>;
...
pub type EXEV7CPT_W<'a, const O: u8> = crate::BitWriter<'a, CPT2ECR_SPEC, O>;
...
pub type EXEV8CPT_W<'a, const O: u8> = crate::BitWriter<'a, CPT2ECR_SPEC, O>;
...
pub type EXEV9CPT_W<'a, const O: u8> = crate::BitWriter<'a, CPT2ECR_SPEC, O>;
...
pub type EXEV10CPT_W<'a, const O: u8> = crate::BitWriter<'a, CPT2ECR_SPEC, O>;
...
pub type TA1SET_W<'a, const O: u8> = crate::BitWriter<'a, CPT2ECR_SPEC, O>;
...
pub type TB1SET_W<'a, const O: u8> = crate::BitWriter<'a, CPT2ECR_SPEC, O>;
...
pub type TC1SET_W<'a, const O: u8> = crate::BitWriter<'a, CPT2ECR_SPEC, O>;
...
pub type TD1SET_W<'a, const O: u8> = crate::BitWriter<'a, CPT2ECR_SPEC, O>;
...
#[doc = "`read()` method returns [cpt2ecr::R](R) reader structure"]
impl crate::Readable for CPT2ECR_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [cpt2ecr::W](W) writer structure"]
impl crate::Writable for CPT2ECR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets CPT2ECR to value 0"]
