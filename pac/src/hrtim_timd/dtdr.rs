...
pub struct R(crate::R<DTDR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<DTDR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<DTDR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<DTDR_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `DTDR` writer"]
pub struct W(crate::W<DTDR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<DTDR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<DTDR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<DTDR_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type DTRX_W<'a, const O: u8> = crate::FieldWriter<'a, DTDR_SPEC, 9, O, u16>;
...
pub type SDTRX_W<'a, const O: u8> = crate::BitWriter<'a, DTDR_SPEC, O>;
#[doc = "Field `DTPRSC` reader - Deadtime Prescaler"]
pub type DTPRSC_R = crate::FieldReader;
#[doc = "Field `DTPRSC` writer - Deadtime Prescaler"]
pub type DTPRSC_W<'a, const O: u8> = crate::FieldWriter<'a, DTDR_SPEC, 3, O>;
...
pub type DTRSLKX_W<'a, const O: u8> = crate::BitWriter<'a, DTDR_SPEC, O>;
...
pub type DTRLKX_W<'a, const O: u8> = crate::BitWriter<'a, DTDR_SPEC, O>;
...
pub type DTFX_W<'a, const O: u8> = crate::FieldWriter<'a, DTDR_SPEC, 9, O, u16>;
...
pub type SDTFX_W<'a, const O: u8> = crate::BitWriter<'a, DTDR_SPEC, O>;
...
pub type DTFSLKX_W<'a, const O: u8> = crate::BitWriter<'a, DTDR_SPEC, O>;
...
pub type DTFLKX_W<'a, const O: u8> = crate::BitWriter<'a, DTDR_SPEC, O>;
impl R {
