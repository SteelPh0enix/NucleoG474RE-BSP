...
pub type CMP2_W<'a, const O: u8> = crate::BitWriter<'a, RSTDR_SPEC, O>;
...
pub type EXTEVNT10_W<'a, const O: u8> = crate::BitWriter<'a, RSTDR_SPEC, O>;
...
pub type TIMACMP1_W<'a, const O: u8> = crate::BitWriter<'a, RSTDR_SPEC, O>;
...
pub type TIMACMP2_W<'a, const O: u8> = crate::BitWriter<'a, RSTDR_SPEC, O>;
...
pub type TIMACMP4_W<'a, const O: u8> = crate::BitWriter<'a, RSTDR_SPEC, O>;
...
pub type TIMBCMP1_W<'a, const O: u8> = crate::BitWriter<'a, RSTDR_SPEC, O>;
...
pub type TIMBCMP2_W<'a, const O: u8> = crate::BitWriter<'a, RSTDR_SPEC, O>;
...
pub type TIMBCMP4_W<'a, const O: u8> = crate::BitWriter<'a, RSTDR_SPEC, O>;
...
pub type TIMCCMP1_W<'a, const O: u8> = crate::BitWriter<'a, RSTDR_SPEC, O>;
...
pub type TIMCCMP2_W<'a, const O: u8> = crate::BitWriter<'a, RSTDR_SPEC, O>;
...
pub type TIMCCMP4_W<'a, const O: u8> = crate::BitWriter<'a, RSTDR_SPEC, O>;
...
pub type TIMECMP1_W<'a, const O: u8> = crate::BitWriter<'a, RSTDR_SPEC, O>;
...
pub type TIMECMP2_W<'a, const O: u8> = crate::BitWriter<'a, RSTDR_SPEC, O>;
...
pub type TIMECMP4_W<'a, const O: u8> = crate::BitWriter<'a, RSTDR_SPEC, O>;
#[doc = "Field `TIMFCPM2` reader - Timer F Compare 2"]
pub type TIMFCPM2_R = crate::BitReader;
#[doc = "Field `TIMFCPM2` writer - Timer F Compare 2"]
pub type TIMFCPM2_W<'a, const O: u8> = crate::BitWriter<'a, RSTDR_SPEC, O>;
impl R {
