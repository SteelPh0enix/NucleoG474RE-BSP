...
pub type EEVACE_W<'a, const O: u8> = crate::BitWriter<'a, DEEFR3_SPEC, O>;
...
pub type EEVACRES_W<'a, const O: u8> = crate::BitWriter<'a, DEEFR3_SPEC, O>;
...
pub type EEVARSTM_W<'a, const O: u8> = crate::BitWriter<'a, DEEFR3_SPEC, O>;
...
pub type EEVASEL_W<'a, const O: u8> = crate::FieldWriter<'a, DEEFR3_SPEC, 4, O>;
...
pub type EEVACNT_W<'a, const O: u8> = crate::FieldWriter<'a, DEEFR3_SPEC, 6, O>;
impl R {
