...
pub type FAULT1_W<'a, const O: u8> = crate::FieldWriter<'a, OUTDR_SPEC, 2, O>;
...
pub type CHP1_W<'a, const O: u8> = crate::BitWriter<'a, OUTDR_SPEC, O>;
...
pub type DIDL1_W<'a, const O: u8> = crate::BitWriter<'a, OUTDR_SPEC, O>;
#[doc = "Field `DTEN` reader - Deadtime enable"]
pub type DTEN_R = crate::BitReader;
#[doc = "Field `DTEN` writer - Deadtime enable"]
pub type DTEN_W<'a, const O: u8> = crate::BitWriter<'a, OUTDR_SPEC, O>;
...
pub type DLYPRTEN_W<'a, const O: u8> = crate::BitWriter<'a, OUTDR_SPEC, O>;
#[doc = "Field `DLYPRT` reader - Delayed Protection"]
pub type DLYPRT_R = crate::FieldReader;
#[doc = "Field `DLYPRT` writer - Delayed Protection"]
pub type DLYPRT_W<'a, const O: u8> = crate::FieldWriter<'a, OUTDR_SPEC, 3, O>;
...
pub type FAULT2_W<'a, const O: u8> = crate::FieldWriter<'a, OUTDR_SPEC, 2, O>;
...
pub type CHP2_W<'a, const O: u8> = crate::BitWriter<'a, OUTDR_SPEC, O>;
...
pub type DIDL2_W<'a, const O: u8> = crate::BitWriter<'a, OUTDR_SPEC, O>;
impl R {
