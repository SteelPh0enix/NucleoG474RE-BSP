...
pub type EE6LTCH_W<'a, const O: u8> = crate::BitWriter<'a, EEFDR2_SPEC, O>;
...
pub type EE6FLTR_W<'a, const O: u8> = crate::FieldWriter<'a, EEFDR2_SPEC, 4, O>;
...
pub type EE7LTCH_W<'a, const O: u8> = crate::BitWriter<'a, EEFDR2_SPEC, O>;
...
pub type EE7FLTR_W<'a, const O: u8> = crate::FieldWriter<'a, EEFDR2_SPEC, 4, O>;
...
pub type EE8LTCH_W<'a, const O: u8> = crate::BitWriter<'a, EEFDR2_SPEC, O>;
...
pub type EE8FLTR_W<'a, const O: u8> = crate::FieldWriter<'a, EEFDR2_SPEC, 4, O>;
...
pub type EE9LTCH_W<'a, const O: u8> = crate::BitWriter<'a, EEFDR2_SPEC, O>;
...
pub type EE9FLTR_W<'a, const O: u8> = crate::FieldWriter<'a, EEFDR2_SPEC, 4, O>;
...
pub type EE10LTCH_W<'a, const O: u8> = crate::BitWriter<'a, EEFDR2_SPEC, O>;
...
pub type EE10FLTR_W<'a, const O: u8> = crate::FieldWriter<'a, EEFDR2_SPEC, 4, O>;
impl R {
