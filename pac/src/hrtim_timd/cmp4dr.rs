...
pub struct R(crate::R<CMP4DR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CMP4DR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<CMP4DR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<CMP4DR_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `CMP4DR` writer"]
pub struct W(crate::W<CMP4DR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CMP4DR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<CMP4DR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<CMP4DR_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type CMP4X_W<'a, const O: u8> = crate::FieldWriter<'a, CMP4DR_SPEC, 16, O, u16>;
impl R {
