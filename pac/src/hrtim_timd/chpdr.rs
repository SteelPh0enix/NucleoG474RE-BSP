...
pub type CHPFRQ_W<'a, const O: u8> = crate::FieldWriter<'a, CHPDR_SPEC, 4, O>;
...
pub type CHPDTY_W<'a, const O: u8> = crate::FieldWriter<'a, CHPDR_SPEC, 3, O>;
#[doc = "Field `STRTPW` reader - STRTPW"]
pub type STRTPW_R = crate::FieldReader;
#[doc = "Field `STRTPW` writer - STRTPW"]
pub type STRTPW_W<'a, const O: u8> = crate::FieldWriter<'a, CHPDR_SPEC, 4, O>;
impl R {
