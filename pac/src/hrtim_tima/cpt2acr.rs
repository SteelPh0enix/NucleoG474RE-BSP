...
pub struct R(crate::R<CPT2ACR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CPT2ACR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<CPT2ACR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<CPT2ACR_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `CPT2ACR` writer"]
pub struct W(crate::W<CPT2ACR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CPT2ACR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<CPT2ACR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<CPT2ACR_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type SWCPT_W<'a, const O: u8> = crate::BitWriter<'a, CPT2ACR_SPEC, O>;
#[doc = "Field `UDPCPT` reader - Update Capture"]
pub type UDPCPT_R = crate::BitReader;
#[doc = "Field `UDPCPT` writer - Update Capture"]
pub type UDPCPT_W<'a, const O: u8> = crate::BitWriter<'a, CPT2ACR_SPEC, O>;
...
pub type EXEV1CPT_W<'a, const O: u8> = crate::BitWriter<'a, CPT2ACR_SPEC, O>;
...
pub type EXEV2CPT_W<'a, const O: u8> = crate::BitWriter<'a, CPT2ACR_SPEC, O>;
...
pub type EXEV3CPT_W<'a, const O: u8> = crate::BitWriter<'a, CPT2ACR_SPEC, O>;
...
pub type EXEV4CPT_W<'a, const O: u8> = crate::BitWriter<'a, CPT2ACR_SPEC, O>;
...
pub type EXEV5CPT_W<'a, const O: u8> = crate::BitWriter<'a, CPT2ACR_SPEC, O>;
...
pub type EXEV6CPT_W<'a, const O: u8> = crate::BitWriter<'a, CPT2ACR_SPEC, O>;
...
pub type EXEV7CPT_W<'a, const O: u8> = crate::BitWriter<'a, CPT2ACR_SPEC, O>;
...
pub type EXEV8CPT_W<'a, const O: u8> = crate::BitWriter<'a, CPT2ACR_SPEC, O>;
...
pub type EXEV9CPT_W<'a, const O: u8> = crate::BitWriter<'a, CPT2ACR_SPEC, O>;
...
pub type TB1SET_W<'a, const O: u8> = crate::BitWriter<'a, CPT2ACR_SPEC, O>;
...
pub type TC1SET_W<'a, const O: u8> = crate::BitWriter<'a, CPT2ACR_SPEC, O>;
...
pub type TD1SET_W<'a, const O: u8> = crate::BitWriter<'a, CPT2ACR_SPEC, O>;
...
pub type TE1SET_W<'a, const O: u8> = crate::BitWriter<'a, CPT2ACR_SPEC, O>;
...
impl R {
    ...
    pub fn tf1set(&self) -> TF1SET_R {
        TF1SET_R::new(((self.bits >> 12) & 1) != 0)
    }
    #[doc = "Bit 13 - TF1RST"]
    #[inline(always)]
    pub fn tf1rst(&self) -> TF1RST_R {
        TF1RST_R::new(((self.bits >> 13) & 1) != 0)
    }
    #[doc = "Bit 14 - TFCMP1"]
    #[inline(always)]
    pub fn tfcmp1(&self) -> TFCMP1_R {
        TFCMP1_R::new(((self.bits >> 14) & 1) != 0)
    }
    #[doc = "Bit 15 - TFCMP2"]
    #[inline(always)]
    pub fn tfcmp2(&self) -> TFCMP2_R {
        TFCMP2_R::new(((self.bits >> 15) & 1) != 0)
    }
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn tf1set(&mut self) -> TF1SET_W<12> {
        TF1SET_W::new(self)
    }
    #[doc = "Bit 13 - TF1RST"]
    #[inline(always)]
    #[must_use]
    pub fn tf1rst(&mut self) -> TF1RST_W<13> {
        TF1RST_W::new(self)
    }
    #[doc = "Bit 14 - TFCMP1"]
    #[inline(always)]
    #[must_use]
    pub fn tfcmp1(&mut self) -> TFCMP1_W<14> {
        TFCMP1_W::new(self)
    }
    #[doc = "Bit 15 - TFCMP2"]
    #[inline(always)]
    #[must_use]
    pub fn tfcmp2(&mut self) -> TFCMP2_W<15> {
        TFCMP2_W::new(self)
    }
    #[doc = "Bit 16 - Timer B output 1 Set"]
    #[inline(always)]
...
#[doc = "CPT2xCR\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [cpt2acr](index.html) module"]
pub struct CPT2ACR_SPEC;
impl crate::RegisterSpec for CPT2ACR_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [cpt2acr::R](R) reader structure"]
impl crate::Readable for CPT2ACR_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [cpt2acr::W](W) writer structure"]
impl crate::Writable for CPT2ACR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets CPT2ACR to value 0"]
impl crate::Resettable for CPT2ACR_SPEC {
