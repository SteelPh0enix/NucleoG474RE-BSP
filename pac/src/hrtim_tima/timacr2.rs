...
pub type DCDE_W<'a, const O: u8> = crate::BitWriter<'a, TIMACR2_SPEC, O>;
...
pub type DCDS_W<'a, const O: u8> = crate::BitWriter<'a, TIMACR2_SPEC, O>;
...
pub type OUTROM_W<'a, const O: u8> = crate::FieldWriter<'a, TIMACR2_SPEC, 2, O>;
#[doc = "Field `ADROM` reader - ADC Roll-Over Mode"]
pub type ADROM_R = crate::FieldReader;
#[doc = "Field `ADROM` writer - ADC Roll-Over Mode"]
pub type ADROM_W<'a, const O: u8> = crate::FieldWriter<'a, TIMACR2_SPEC, 2, O>;
...
pub type BMROM_W<'a, const O: u8> = crate::FieldWriter<'a, TIMACR2_SPEC, 2, O>;
...
pub type FEROM_W<'a, const O: u8> = crate::FieldWriter<'a, TIMACR2_SPEC, 2, O>;
...
pub type GTCMP1_W<'a, const O: u8> = crate::BitWriter<'a, TIMACR2_SPEC, O>;
...
pub type GTCMP3_W<'a, const O: u8> = crate::BitWriter<'a, TIMACR2_SPEC, O>;
#[doc = "Field `TRGHLF` reader - Triggered-half mode"]
pub type TRGHLF_R = crate::BitReader;
#[doc = "Field `TRGHLF` writer - Triggered-half mode"]
pub type TRGHLF_W<'a, const O: u8> = crate::BitWriter<'a, TIMACR2_SPEC, O>;
impl R {
