...
pub type FBOFF_W<'a, const O: u8> = crate::FieldWriter<'a, ASLOTR_SPEC, 5, O>;
#[doc = "Field `SLOTSZ` reader - Slot size"]
pub type SLOTSZ_R = crate::FieldReader;
#[doc = "Field `SLOTSZ` writer - Slot size"]
pub type SLOTSZ_W<'a, const O: u8> = crate::FieldWriter<'a, ASLOTR_SPEC, 2, O>;
...
pub type NBSLOT_W<'a, const O: u8> = crate::FieldWriter<'a, ASLOTR_SPEC, 4, O>;
#[doc = "Field `SLOTEN` reader - Slot enable"]
pub type SLOTEN_R = crate::FieldReader<u16>;
#[doc = "Field `SLOTEN` writer - Slot enable"]
pub type SLOTEN_W<'a, const O: u8> = crate::FieldWriter<'a, ASLOTR_SPEC, 16, O, u16>;
impl R {
