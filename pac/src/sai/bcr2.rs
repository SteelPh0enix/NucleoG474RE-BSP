...
pub type FTH_W<'a, const O: u8> = crate::FieldWriter<'a, BCR2_SPEC, 3, O>;
#[doc = "Field `FFLUS` reader - FIFO flush"]
pub type FFLUS_R = crate::BitReader;
#[doc = "Field `FFLUS` writer - FIFO flush"]
pub type FFLUS_W<'a, const O: u8> = crate::BitWriter<'a, BCR2_SPEC, O>;
