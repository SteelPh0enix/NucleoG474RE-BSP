...
pub type FRL_W<'a, const O: u8> = crate::FieldWriter<'a, BFRCR_SPEC, 8, O>;
...
pub type FSALL_W<'a, const O: u8> = crate::FieldWriter<'a, BFRCR_SPEC, 7, O>;
...
pub type FSDEF_W<'a, const O: u8> = crate::BitWriter<'a, BFRCR_SPEC, O>;
...
pub type FSPOL_W<'a, const O: u8> = crate::BitWriter<'a, BFRCR_SPEC, O>;
...
pub type FSOFF_W<'a, const O: u8> = crate::BitWriter<'a, BFRCR_SPEC, O>;
impl R {
