...
pub type OA2_W<'a, const O: u8> = crate::FieldWriter<'a, OAR2_SPEC, 7, O>;
...
pub type OA2MSK_W<'a, const O: u8> = crate::FieldWriter<'a, OAR2_SPEC, 3, O>;
#[doc = "Field `OA2EN` reader - Own Address 2 enable"]
pub type OA2EN_R = crate::BitReader;
#[doc = "Field `OA2EN` writer - Own Address 2 enable"]
pub type OA2EN_W<'a, const O: u8> = crate::BitWriter<'a, OAR2_SPEC, O>;
impl R {
