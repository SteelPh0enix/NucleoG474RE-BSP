...
pub type TIMEOUTA_W<'a, const O: u8> = crate::FieldWriter<'a, TIMEOUTR_SPEC, 12, O, u16>;
...
pub type TIDLE_W<'a, const O: u8> = crate::BitWriter<'a, TIMEOUTR_SPEC, O>;
...
pub type TIMOUTEN_W<'a, const O: u8> = crate::BitWriter<'a, TIMEOUTR_SPEC, O>;
#[doc = "Field `TIMEOUTB` reader - Bus timeout B"]
pub type TIMEOUTB_R = crate::FieldReader<u16>;
#[doc = "Field `TIMEOUTB` writer - Bus timeout B"]
pub type TIMEOUTB_W<'a, const O: u8> = crate::FieldWriter<'a, TIMEOUTR_SPEC, 12, O, u16>;
...
pub type TEXTEN_W<'a, const O: u8> = crate::BitWriter<'a, TIMEOUTR_SPEC, O>;
impl R {
