...
pub type OA1_W<'a, const O: u8> = crate::FieldWriter<'a, OAR1_SPEC, 10, O, u16>;
...
pub type OA1MODE_W<'a, const O: u8> = crate::BitWriter<'a, OAR1_SPEC, O>;
#[doc = "Field `OA1EN` reader - Own Address 1 enable"]
pub type OA1EN_R = crate::BitReader;
#[doc = "Field `OA1EN` writer - Own Address 1 enable"]
pub type OA1EN_W<'a, const O: u8> = crate::BitWriter<'a, OAR1_SPEC, O>;
impl R {
