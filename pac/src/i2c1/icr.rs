...
pub type ADDRCF_W<'a, const O: u8> = crate::BitWriter<'a, ICR_SPEC, O>;
#[doc = "Field `NACKCF` writer - Not Acknowledge flag clear"]
pub type NACKCF_W<'a, const O: u8> = crate::BitWriter<'a, ICR_SPEC, O>;
#[doc = "Field `STOPCF` writer - Stop detection flag clear"]
pub type STOPCF_W<'a, const O: u8> = crate::BitWriter<'a, ICR_SPEC, O>;
#[doc = "Field `BERRCF` writer - Bus error flag clear"]
pub type BERRCF_W<'a, const O: u8> = crate::BitWriter<'a, ICR_SPEC, O>;
#[doc = "Field `ARLOCF` writer - Arbitration lost flag clear"]
pub type ARLOCF_W<'a, const O: u8> = crate::BitWriter<'a, ICR_SPEC, O>;
#[doc = "Field `OVRCF` writer - Overrun/Underrun flag clear"]
pub type OVRCF_W<'a, const O: u8> = crate::BitWriter<'a, ICR_SPEC, O>;
#[doc = "Field `PECCF` writer - PEC Error flag clear"]
pub type PECCF_W<'a, const O: u8> = crate::BitWriter<'a, ICR_SPEC, O>;
#[doc = "Field `TIMOUTCF` writer - Timeout detection flag clear"]
pub type TIMOUTCF_W<'a, const O: u8> = crate::BitWriter<'a, ICR_SPEC, O>;
#[doc = "Field `ALERTCF` writer - Alert flag clear"]
pub type ALERTCF_W<'a, const O: u8> = crate::BitWriter<'a, ICR_SPEC, O>;
impl W {
