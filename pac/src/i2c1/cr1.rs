...
pub type ADDRIE_W<'a, const O: u8> = crate::BitWriter<'a, CR1_SPEC, O>;
...
pub type NACKIE_W<'a, const O: u8> = crate::BitWriter<'a, CR1_SPEC, O>;
...
pub type STOPIE_W<'a, const O: u8> = crate::BitWriter<'a, CR1_SPEC, O>;
...
pub type ERRIE_W<'a, const O: u8> = crate::BitWriter<'a, CR1_SPEC, O>;
#[doc = "Field `DNF` reader - Digital noise filter"]
pub type DNF_R = crate::FieldReader;
#[doc = "Field `DNF` writer - Digital noise filter"]
pub type DNF_W<'a, const O: u8> = crate::FieldWriter<'a, CR1_SPEC, 4, O>;
...
pub type ANFOFF_W<'a, const O: u8> = crate::BitWriter<'a, CR1_SPEC, O>;
...
pub type TXDMAEN_W<'a, const O: u8> = crate::BitWriter<'a, CR1_SPEC, O>;
...
pub type RXDMAEN_W<'a, const O: u8> = crate::BitWriter<'a, CR1_SPEC, O>;
#[doc = "Field `SBC` reader - Slave byte control"]
pub type SBC_R = crate::BitReader;
#[doc = "Field `SBC` writer - Slave byte control"]
pub type SBC_W<'a, const O: u8> = crate::BitWriter<'a, CR1_SPEC, O>;
...
pub type NOSTRETCH_W<'a, const O: u8> = crate::BitWriter<'a, CR1_SPEC, O>;
...
pub type WUPEN_W<'a, const O: u8> = crate::BitWriter<'a, CR1_SPEC, O>;
#[doc = "Field `GCEN` reader - General call enable"]
pub type GCEN_R = crate::BitReader;
#[doc = "Field `GCEN` writer - General call enable"]
pub type GCEN_W<'a, const O: u8> = crate::BitWriter<'a, CR1_SPEC, O>;
...
pub type SMBHEN_W<'a, const O: u8> = crate::BitWriter<'a, CR1_SPEC, O>;
