...
pub type CKSEL_W<'a, const O: u8> = crate::BitWriter<'a, CFGR_SPEC, O>;
#[doc = "Field `CKPOL` reader - Clock Polarity"]
pub type CKPOL_R = crate::FieldReader;
#[doc = "Field `CKPOL` writer - Clock Polarity"]
pub type CKPOL_W<'a, const O: u8> = crate::FieldWriter<'a, CFGR_SPEC, 2, O>;
...
pub type CKFLT_W<'a, const O: u8> = crate::FieldWriter<'a, CFGR_SPEC, 2, O>;
...
pub type WAVPOL_W<'a, const O: u8> = crate::BitWriter<'a, CFGR_SPEC, O>;
...
pub type PRELOAD_W<'a, const O: u8> = crate::BitWriter<'a, CFGR_SPEC, O>;
...
pub type COUNTMODE_W<'a, const O: u8> = crate::BitWriter<'a, CFGR_SPEC, O>;
#[doc = "Field `ENC` reader - Encoder mode enable"]
pub type ENC_R = crate::BitReader;
#[doc = "Field `ENC` writer - Encoder mode enable"]
pub type ENC_W<'a, const O: u8> = crate::BitWriter<'a, CFGR_SPEC, O>;
impl R {
    ...
    pub fn trigsel(&self) -> TRIGSEL_R {
        TRIGSEL_R::new(((self.bits >> 13) & 0x0f) as u8)
    }
