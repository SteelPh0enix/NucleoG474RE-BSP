...
pub type CMPMIE_W<'a, const O: u8> = crate::BitWriter<'a, IER_SPEC, O>;
...
pub type ARRMIE_W<'a, const O: u8> = crate::BitWriter<'a, IER_SPEC, O>;
...
pub type EXTTRIGIE_W<'a, const O: u8> = crate::BitWriter<'a, IER_SPEC, O>;
...
pub type CMPOKIE_W<'a, const O: u8> = crate::BitWriter<'a, IER_SPEC, O>;
...
pub type ARROKIE_W<'a, const O: u8> = crate::BitWriter<'a, IER_SPEC, O>;
...
pub type UPIE_W<'a, const O: u8> = crate::BitWriter<'a, IER_SPEC, O>;
...
pub type DOWNIE_W<'a, const O: u8> = crate::BitWriter<'a, IER_SPEC, O>;
impl R {
