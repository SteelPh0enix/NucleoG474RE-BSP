...
pub type DBG_SLEEP_W<'a, const O: u8> = crate::BitWriter<'a, CR_SPEC, O>;
#[doc = "Field `DBG_STOP` reader - Debug Stop Mode"]
pub type DBG_STOP_R = crate::BitReader;
#[doc = "Field `DBG_STOP` writer - Debug Stop Mode"]
pub type DBG_STOP_W<'a, const O: u8> = crate::BitWriter<'a, CR_SPEC, O>;
...
pub type DBG_STANDBY_W<'a, const O: u8> = crate::BitWriter<'a, CR_SPEC, O>;
...
pub type TRACE_IOEN_W<'a, const O: u8> = crate::BitWriter<'a, CR_SPEC, O>;
...
pub type TRACE_MODE_W<'a, const O: u8> = crate::FieldWriter<'a, CR_SPEC, 2, O>;
impl R {
