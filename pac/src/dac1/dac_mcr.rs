...
pub type MODE1_W<'a, const O: u8> = crate::FieldWriter<'a, DAC_MCR_SPEC, 3, O>;
...
pub type DMADOUBLE1_W<'a, const O: u8> = crate::BitWriter<'a, DAC_MCR_SPEC, O>;
...
pub type SINFORMAT1_W<'a, const O: u8> = crate::BitWriter<'a, DAC_MCR_SPEC, O>;
...
pub type HFSEL_W<'a, const O: u8> = crate::FieldWriter<'a, DAC_MCR_SPEC, 2, O>;
...
pub type MODE2_W<'a, const O: u8> = crate::FieldWriter<'a, DAC_MCR_SPEC, 3, O>;
...
pub type DMADOUBLE2_W<'a, const O: u8> = crate::BitWriter<'a, DAC_MCR_SPEC, O>;
...
pub type SINFORMAT2_W<'a, const O: u8> = crate::BitWriter<'a, DAC_MCR_SPEC, O>;
impl R {
    #[doc = "Bits 0:2 - DAC Channel 1 mode These bits can be written only when the DAC is disabled and not in the calibration mode (when bit EN1=0 and bit CEN1 =0 in the DAC_CR register). If EN1=1 or CEN1 =1 the write operation is ignored. They can be set and cleared by software to select the DAC Channel 1 mode: DAC Channel 1 in normal Mode DAC Channel 1 in sample &amp;amp; hold mode"]
    #[inline(always)]
