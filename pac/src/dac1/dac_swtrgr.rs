...
pub type SWTRIG1_W<'a, const O: u8> = crate::BitWriter<'a, DAC_SWTRGR_SPEC, O>;
...
pub type SWTRIG2_W<'a, const O: u8> = crate::BitWriter<'a, DAC_SWTRGR_SPEC, O>;
#[doc = "Field `SWTRIGB1` writer - DAC channel1 software trigger B"]
pub type SWTRIGB1_W<'a, const O: u8> = crate::BitWriter<'a, DAC_SWTRGR_SPEC, O>;
#[doc = "Field `SWTRIGB2` writer - DAC channel2 software trigger B"]
pub type SWTRIGB2_W<'a, const O: u8> = crate::BitWriter<'a, DAC_SWTRGR_SPEC, O>;
impl W {
