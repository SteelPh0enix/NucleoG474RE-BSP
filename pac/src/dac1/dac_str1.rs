...
pub type STRSTDATA1_W<'a, const O: u8> = crate::FieldWriter<'a, DAC_STR1_SPEC, 12, O, u16>;
...
pub type STDIR1_W<'a, const O: u8> = crate::BitWriter<'a, DAC_STR1_SPEC, O>;
...
pub type STINCDATA1_W<'a, const O: u8> = crate::FieldWriter<'a, DAC_STR1_SPEC, 16, O, u16>;
impl R {
