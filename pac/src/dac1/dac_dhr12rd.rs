...
pub struct R(crate::R<DAC_DHR12RD_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<DAC_DHR12RD_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<DAC_DHR12RD_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<DAC_DHR12RD_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `DAC_DHR12RD` writer"]
pub struct W(crate::W<DAC_DHR12RD_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<DAC_DHR12RD_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<DAC_DHR12RD_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<DAC_DHR12RD_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type DACC1DHR_W<'a, const O: u8> = crate::FieldWriter<'a, DAC_DHR12RD_SPEC, 12, O, u16>;
...
pub type DACC2DHR_W<'a, const O: u8> = crate::FieldWriter<'a, DAC_DHR12RD_SPEC, 12, O, u16>;
impl R {
