...
pub type DAC1RDY_W<'a, const O: u8> = crate::BitWriter<'a, DAC_SR_SPEC, O>;
...
pub type DORSTAT1_W<'a, const O: u8> = crate::BitWriter<'a, DAC_SR_SPEC, O>;
...
pub type DMAUDR1_W<'a, const O: u8> = crate::BitWriter<'a, DAC_SR_SPEC, O>;
...
pub type DAC2RDY_W<'a, const O: u8> = crate::BitWriter<'a, DAC_SR_SPEC, O>;
...
pub type DORSTAT2_W<'a, const O: u8> = crate::BitWriter<'a, DAC_SR_SPEC, O>;
...
pub type DMAUDR2_W<'a, const O: u8> = crate::BitWriter<'a, DAC_SR_SPEC, O>;
