...
pub type EN1_W<'a, const O: u8> = crate::BitWriter<'a, DAC_CR_SPEC, O>;
...
pub type TEN1_W<'a, const O: u8> = crate::BitWriter<'a, DAC_CR_SPEC, O>;
...
pub type TSEL1_W<'a, const O: u8> = crate::FieldWriter<'a, DAC_CR_SPEC, 4, O>;
...
pub type WAVE1_W<'a, const O: u8> = crate::FieldWriter<'a, DAC_CR_SPEC, 2, O>;
...
of LFSR/ triangle amplitude equal to 4095"]
pub type MAMP1_W<'a, const O: u8> = crate::FieldWriter<'a, DAC_CR_SPEC, 4, O>;
...
pub type DMAEN1_W<'a, const O: u8> = crate::BitWriter<'a, DAC_CR_SPEC, O>;
...
pub type DMAUDRIE1_W<'a, const O: u8> = crate::BitWriter<'a, DAC_CR_SPEC, O>;
...
pub type CEN1_W<'a, const O: u8> = crate::BitWriter<'a, DAC_CR_SPEC, O>;
...
pub type EN2_W<'a, const O: u8> = crate::BitWriter<'a, DAC_CR_SPEC, O>;
...
pub type TEN2_W<'a, const O: u8> = crate::BitWriter<'a, DAC_CR_SPEC, O>;
...
pub type TSEL2_W<'a, const O: u8> = crate::FieldWriter<'a, DAC_CR_SPEC, 4, O>;
...
pub type WAVE2_W<'a, const O: u8> = crate::FieldWriter<'a, DAC_CR_SPEC, 2, O>;
...
of LFSR/ triangle amplitude equal to 4095"]
pub type MAMP2_W<'a, const O: u8> = crate::FieldWriter<'a, DAC_CR_SPEC, 4, O>;
...
pub type DMAEN2_W<'a, const O: u8> = crate::BitWriter<'a, DAC_CR_SPEC, O>;
...
pub type DMAUDRIE2_W<'a, const O: u8> = crate::BitWriter<'a, DAC_CR_SPEC, O>;
...
pub type CEN2_W<'a, const O: u8> = crate::BitWriter<'a, DAC_CR_SPEC, O>;
impl R {
