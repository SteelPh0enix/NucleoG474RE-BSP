...
pub type STRSTDATA2_W<'a, const O: u8> = crate::FieldWriter<'a, DAC_STR2_SPEC, 12, O, u16>;
...
pub type STDIR2_W<'a, const O: u8> = crate::BitWriter<'a, DAC_STR2_SPEC, O>;
...
pub type STINCDATA2_W<'a, const O: u8> = crate::FieldWriter<'a, DAC_STR2_SPEC, 16, O, u16>;
impl R {
