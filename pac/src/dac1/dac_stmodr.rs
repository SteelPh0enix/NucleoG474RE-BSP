...
pub type STRSTTRIGSEL1_W<'a, const O: u8> = crate::FieldWriter<'a, DAC_STMODR_SPEC, 4, O>;
...
pub type STINCTRIGSEL1_W<'a, const O: u8> = crate::FieldWriter<'a, DAC_STMODR_SPEC, 4, O>;
...
pub type STRSTTRIGSEL2_W<'a, const O: u8> = crate::FieldWriter<'a, DAC_STMODR_SPEC, 4, O>;
...
pub type STINCTRIGSEL2_W<'a, const O: u8> = crate::FieldWriter<'a, DAC_STMODR_SPEC, 4, O>;
impl R {
