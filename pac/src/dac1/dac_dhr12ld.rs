...
pub type DACC1DHR_W<'a, const O: u8> = crate::FieldWriter<'a, DAC_DHR12LD_SPEC, 12, O, u16>;
...
pub type DACC2DHR_W<'a, const O: u8> = crate::FieldWriter<'a, DAC_DHR12LD_SPEC, 12, O, u16>;
impl R {
