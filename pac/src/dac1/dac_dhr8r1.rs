...
pub type DACC1DHR_W<'a, const O: u8> = crate::FieldWriter<'a, DAC_DHR8R1_SPEC, 8, O>;
...
pub type DACC1DHRB_W<'a, const O: u8> = crate::FieldWriter<'a, DAC_DHR8R1_SPEC, 8, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dacc1dhrb(&mut self) -> DACC1DHRB_W<8> {
