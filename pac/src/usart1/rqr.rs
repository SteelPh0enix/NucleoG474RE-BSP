...
pub type ABRRQ_W<'a, const O: u8> = crate::BitWriter<'a, RQR_SPEC, O>;
#[doc = "Field `SBKRQ` writer - Send break request"]
pub type SBKRQ_W<'a, const O: u8> = crate::BitWriter<'a, RQR_SPEC, O>;
#[doc = "Field `MMRQ` writer - Mute mode request"]
pub type MMRQ_W<'a, const O: u8> = crate::BitWriter<'a, RQR_SPEC, O>;
#[doc = "Field `RXFRQ` writer - Receive data flush request"]
pub type RXFRQ_W<'a, const O: u8> = crate::BitWriter<'a, RQR_SPEC, O>;
#[doc = "Field `TXFRQ` writer - Transmit data flush request"]
pub type TXFRQ_W<'a, const O: u8> = crate::BitWriter<'a, RQR_SPEC, O>;
impl W {
