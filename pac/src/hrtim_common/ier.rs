...
pub type FLT1IE_W<'a, const O: u8> = crate::BitWriter<'a, IER_SPEC, O>;
...
pub type FLT2IE_W<'a, const O: u8> = crate::BitWriter<'a, IER_SPEC, O>;
...
pub type FLT3IE_W<'a, const O: u8> = crate::BitWriter<'a, IER_SPEC, O>;
...
pub type FLT4IE_W<'a, const O: u8> = crate::BitWriter<'a, IER_SPEC, O>;
...
pub type FLT5IE_W<'a, const O: u8> = crate::BitWriter<'a, IER_SPEC, O>;
...
pub type SYSFLTE_W<'a, const O: u8> = crate::BitWriter<'a, IER_SPEC, O>;
#[doc = "Field `FLT6IE` reader - Fault 6 Interrupt Enable"]
pub type FLT6IE_R = crate::BitReader;
#[doc = "Field `FLT6IE` writer - Fault 6 Interrupt Enable"]
pub type FLT6IE_W<'a, const O: u8> = crate::BitWriter<'a, IER_SPEC, O>;
...
pub type DLLRDYIE_W<'a, const O: u8> = crate::BitWriter<'a, IER_SPEC, O>;
...
pub type BMPERIE_W<'a, const O: u8> = crate::BitWriter<'a, IER_SPEC, O>;
impl R {
