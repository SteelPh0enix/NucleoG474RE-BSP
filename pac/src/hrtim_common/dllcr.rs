...
pub type CAL_W<'a, const O: u8> = crate::BitWriter<'a, DLLCR_SPEC, O>;
...
pub type CALEN_W<'a, const O: u8> = crate::BitWriter<'a, DLLCR_SPEC, O>;
...
pub type CALRTE_W<'a, const O: u8> = crate::FieldWriter<'a, DLLCR_SPEC, 2, O>;
impl R {
