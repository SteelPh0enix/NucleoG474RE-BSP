...
pub type MUDIS_W<'a, const O: u8> = crate::BitWriter<'a, CR1_SPEC, O>;
...
pub type TAUDIS_W<'a, const O: u8> = crate::BitWriter<'a, CR1_SPEC, O>;
...
pub type TBUDIS_W<'a, const O: u8> = crate::BitWriter<'a, CR1_SPEC, O>;
...
pub type TCUDIS_W<'a, const O: u8> = crate::BitWriter<'a, CR1_SPEC, O>;
...
pub type TDUDIS_W<'a, const O: u8> = crate::BitWriter<'a, CR1_SPEC, O>;
...
pub type TEUDIS_W<'a, const O: u8> = crate::BitWriter<'a, CR1_SPEC, O>;
...
pub type TFUDIS_W<'a, const O: u8> = crate::BitWriter<'a, CR1_SPEC, O>;
...
pub type AD1USRC_W<'a, const O: u8> = crate::FieldWriter<'a, CR1_SPEC, 3, O>;
...
pub type AD2USRC_W<'a, const O: u8> = crate::FieldWriter<'a, CR1_SPEC, 3, O>;
...
pub type AD3USRC_W<'a, const O: u8> = crate::FieldWriter<'a, CR1_SPEC, 3, O>;
...
pub type AD4USRC_W<'a, const O: u8> = crate::FieldWriter<'a, CR1_SPEC, 3, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn tfudis(&mut self) -> TFUDIS_W<6> {
        TFUDIS_W::new(self)
    }
    #[doc = "Bits 16:18 - ADC Trigger 1 Update Source"]
    #[inline(always)]
