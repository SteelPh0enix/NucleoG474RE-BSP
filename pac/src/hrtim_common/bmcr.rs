...
pub type BME_W<'a, const O: u8> = crate::BitWriter<'a, BMCR_SPEC, O>;
...
pub type BMOM_W<'a, const O: u8> = crate::BitWriter<'a, BMCR_SPEC, O>;
...
pub type BMCLK_W<'a, const O: u8> = crate::FieldWriter<'a, BMCR_SPEC, 4, O>;
...
pub type BMPRSC_W<'a, const O: u8> = crate::FieldWriter<'a, BMCR_SPEC, 4, O>;
...
pub type BMPREN_W<'a, const O: u8> = crate::BitWriter<'a, BMCR_SPEC, O>;
