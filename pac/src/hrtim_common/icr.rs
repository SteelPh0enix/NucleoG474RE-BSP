...
pub type FLT1C_W<'a, const O: u8> = crate::BitWriter<'a, ICR_SPEC, O>;
#[doc = "Field `FLT2C` writer - Fault 2 Interrupt Flag Clear"]
pub type FLT2C_W<'a, const O: u8> = crate::BitWriter<'a, ICR_SPEC, O>;
#[doc = "Field `FLT3C` writer - Fault 3 Interrupt Flag Clear"]
pub type FLT3C_W<'a, const O: u8> = crate::BitWriter<'a, ICR_SPEC, O>;
#[doc = "Field `FLT4C` writer - Fault 4 Interrupt Flag Clear"]
pub type FLT4C_W<'a, const O: u8> = crate::BitWriter<'a, ICR_SPEC, O>;
#[doc = "Field `FLT5C` writer - Fault 5 Interrupt Flag Clear"]
pub type FLT5C_W<'a, const O: u8> = crate::BitWriter<'a, ICR_SPEC, O>;
#[doc = "Field `SYSFLTC` writer - System Fault Interrupt Flag Clear"]
pub type SYSFLTC_W<'a, const O: u8> = crate::BitWriter<'a, ICR_SPEC, O>;
#[doc = "Field `FLT6C` writer - Fault 6 Interrupt Flag Clear"]
pub type FLT6C_W<'a, const O: u8> = crate::BitWriter<'a, ICR_SPEC, O>;
#[doc = "Field `DLLRDYC` writer - DLL Ready Interrupt flag Clear"]
pub type DLLRDYC_W<'a, const O: u8> = crate::BitWriter<'a, ICR_SPEC, O>;
#[doc = "Field `BMPERC` writer - Burst mode period flag Clear"]
pub type BMPERC_W<'a, const O: u8> = crate::BitWriter<'a, ICR_SPEC, O>;
impl W {
