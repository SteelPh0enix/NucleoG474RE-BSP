...
pub type PECF_W<'a, const O: u8> = crate::BitWriter<'a, ICR_SPEC, O>;
#[doc = "Field `FECF` writer - Framing error clear flag"]
pub type FECF_W<'a, const O: u8> = crate::BitWriter<'a, ICR_SPEC, O>;
#[doc = "Field `NCF` writer - Noise detected clear flag"]
pub type NCF_W<'a, const O: u8> = crate::BitWriter<'a, ICR_SPEC, O>;
#[doc = "Field `ORECF` writer - Overrun error clear flag"]
pub type ORECF_W<'a, const O: u8> = crate::BitWriter<'a, ICR_SPEC, O>;
#[doc = "Field `IDLECF` writer - Idle line detected clear flag"]
pub type IDLECF_W<'a, const O: u8> = crate::BitWriter<'a, ICR_SPEC, O>;
#[doc = "Field `TXFECF` writer - TXFECF"]
pub type TXFECF_W<'a, const O: u8> = crate::BitWriter<'a, ICR_SPEC, O>;
#[doc = "Field `TCCF` writer - Transmission complete clear flag"]
pub type TCCF_W<'a, const O: u8> = crate::BitWriter<'a, ICR_SPEC, O>;
#[doc = "Field `TCBGTCF` writer - TCBGTCF"]
pub type TCBGTCF_W<'a, const O: u8> = crate::BitWriter<'a, ICR_SPEC, O>;
#[doc = "Field `LBDCF` writer - LIN break detection clear flag"]
pub type LBDCF_W<'a, const O: u8> = crate::BitWriter<'a, ICR_SPEC, O>;
#[doc = "Field `CTSCF` writer - CTS clear flag"]
pub type CTSCF_W<'a, const O: u8> = crate::BitWriter<'a, ICR_SPEC, O>;
#[doc = "Field `RTOCF` writer - Receiver timeout clear flag"]
pub type RTOCF_W<'a, const O: u8> = crate::BitWriter<'a, ICR_SPEC, O>;
#[doc = "Field `EOBCF` writer - End of block clear flag"]
pub type EOBCF_W<'a, const O: u8> = crate::BitWriter<'a, ICR_SPEC, O>;
#[doc = "Field `UDRCF` writer - UDRCF"]
pub type UDRCF_W<'a, const O: u8> = crate::BitWriter<'a, ICR_SPEC, O>;
#[doc = "Field `CMCF` writer - Character match clear flag"]
pub type CMCF_W<'a, const O: u8> = crate::BitWriter<'a, ICR_SPEC, O>;
#[doc = "Field `WUCF` writer - Wakeup from Stop mode clear flag"]
pub type WUCF_W<'a, const O: u8> = crate::BitWriter<'a, ICR_SPEC, O>;
impl W {
