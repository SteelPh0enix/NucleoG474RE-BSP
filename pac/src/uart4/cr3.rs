...
pub type ONEBIT_W<'a, const O: u8> = crate::BitWriter<'a, CR3_SPEC, O>;
#[doc = "Field `OVRDIS` reader - Overrun Disable"]
pub type OVRDIS_R = crate::BitReader;
#[doc = "Field `OVRDIS` writer - Overrun Disable"]
pub type OVRDIS_W<'a, const O: u8> = crate::BitWriter<'a, CR3_SPEC, O>;
...
pub type DDRE_W<'a, const O: u8> = crate::BitWriter<'a, CR3_SPEC, O>;
#[doc = "Field `DEM` reader - Driver enable mode"]
pub type DEM_R = crate::BitReader;
#[doc = "Field `DEM` writer - Driver enable mode"]
pub type DEM_W<'a, const O: u8> = crate::BitWriter<'a, CR3_SPEC, O>;
...
pub type DEP_W<'a, const O: u8> = crate::BitWriter<'a, CR3_SPEC, O>;
...
pub type SCARCNT_W<'a, const O: u8> = crate::FieldWriter<'a, CR3_SPEC, 3, O>;
...
pub type WUS_W<'a, const O: u8> = crate::FieldWriter<'a, CR3_SPEC, 2, O>;
...
pub type WUFIE_W<'a, const O: u8> = crate::BitWriter<'a, CR3_SPEC, O>;
#[doc = "Field `TXFTIE` reader - TXFTIE"]
pub type TXFTIE_R = crate::BitReader;
#[doc = "Field `TXFTIE` writer - TXFTIE"]
pub type TXFTIE_W<'a, const O: u8> = crate::BitWriter<'a, CR3_SPEC, O>;
#[doc = "Field `TCBGTIE` reader - TCBGTIE"]
pub type TCBGTIE_R = crate::BitReader;
#[doc = "Field `TCBGTIE` writer - TCBGTIE"]
pub type TCBGTIE_W<'a, const O: u8> = crate::BitWriter<'a, CR3_SPEC, O>;
#[doc = "Field `RXFTCFG` reader - RXFTCFG"]
pub type RXFTCFG_R = crate::FieldReader;
#[doc = "Field `RXFTCFG` writer - RXFTCFG"]
pub type RXFTCFG_W<'a, const O: u8> = crate::FieldWriter<'a, CR3_SPEC, 3, O>;
#[doc = "Field `RXFTIE` reader - RXFTIE"]
pub type RXFTIE_R = crate::BitReader;
#[doc = "Field `RXFTIE` writer - RXFTIE"]
pub type RXFTIE_W<'a, const O: u8> = crate::BitWriter<'a, CR3_SPEC, O>;
#[doc = "Field `TXFTCFG` reader - TXFTCFG"]
pub type TXFTCFG_R = crate::FieldReader;
#[doc = "Field `TXFTCFG` writer - TXFTCFG"]
pub type TXFTCFG_W<'a, const O: u8> = crate::FieldWriter<'a, CR3_SPEC, 3, O>;
impl R {
