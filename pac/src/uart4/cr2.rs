...
pub type SLVEN_W<'a, const O: u8> = crate::BitWriter<'a, CR2_SPEC, O>;
#[doc = "Field `DIS_NSS` reader - DIS_NSS"]
pub type DIS_NSS_R = crate::BitReader;
#[doc = "Field `DIS_NSS` writer - DIS_NSS"]
pub type DIS_NSS_W<'a, const O: u8> = crate::BitWriter<'a, CR2_SPEC, O>;
...
pub type ADDM7_W<'a, const O: u8> = crate::BitWriter<'a, CR2_SPEC, O>;
...
pub type LBDL_W<'a, const O: u8> = crate::BitWriter<'a, CR2_SPEC, O>;
...
pub type RXINV_W<'a, const O: u8> = crate::BitWriter<'a, CR2_SPEC, O>;
...
pub type ABRMOD1_W<'a, const O: u8> = crate::BitWriter<'a, CR2_SPEC, O>;
...
pub type RTOEN_W<'a, const O: u8> = crate::BitWriter<'a, CR2_SPEC, O>;
...
pub type ADD0_3_W<'a, const O: u8> = crate::FieldWriter<'a, CR2_SPEC, 4, O>;
...
pub type ADD4_7_W<'a, const O: u8> = crate::FieldWriter<'a, CR2_SPEC, 4, O>;
impl R {
    #[doc = "Bit 0 - SLVEN"]
    #[inline(always)]
