...
pub type EXTI4_W<'a, const O: u8> = crate::FieldWriter<'a, EXTICR2_SPEC, 4, O>;
...
pub type EXTI5_W<'a, const O: u8> = crate::FieldWriter<'a, EXTICR2_SPEC, 4, O>;
...
pub type EXTI6_W<'a, const O: u8> = crate::FieldWriter<'a, EXTICR2_SPEC, 4, O>;
...
pub type EXTI7_W<'a, const O: u8> = crate::FieldWriter<'a, EXTICR2_SPEC, 4, O>;
impl R {
