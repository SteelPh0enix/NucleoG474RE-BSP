...
pub type BIDIOE_W<'a, const O: u8> = crate::BitWriter<'a, CR1_SPEC, O>;
...
pub type BIDIMODE_W<'a, const O: u8> = crate::BitWriter<'a, CR1_SPEC, O>;
impl R {
...
#[doc = "`reset()` method sets CR1 to value 0x0700"]
