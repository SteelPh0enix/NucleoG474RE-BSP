...
pub type LT1_W<'a, const O: u8> = crate::FieldWriter<'a, TR1_SPEC, 12, O, u16>;
#[doc = "Field `AWDFILT` reader - AWDFILT"]
pub type AWDFILT_R = crate::FieldReader;
#[doc = "Field `AWDFILT` writer - AWDFILT"]
pub type AWDFILT_W<'a, const O: u8> = crate::FieldWriter<'a, TR1_SPEC, 3, O>;
#[doc = "Field `HT1` reader - HT1"]
pub type HT1_R = crate::FieldReader<u16>;
#[doc = "Field `HT1` writer - HT1"]
pub type HT1_W<'a, const O: u8> = crate::FieldWriter<'a, TR1_SPEC, 12, O, u16>;
impl R {
    #[doc = "Bits 0:11 - LT1"]
    #[inline(always)]
