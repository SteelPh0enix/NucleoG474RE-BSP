...
pub type MCMP1C_W<'a, const O: u8> = crate::BitWriter<'a, MICR_SPEC, O>;
#[doc = "Field `MCMP2C` writer - Master Compare 2 Interrupt flag clear"]
pub type MCMP2C_W<'a, const O: u8> = crate::BitWriter<'a, MICR_SPEC, O>;
#[doc = "Field `MCMP3C` writer - Master Compare 3 Interrupt flag clear"]
pub type MCMP3C_W<'a, const O: u8> = crate::BitWriter<'a, MICR_SPEC, O>;
#[doc = "Field `MCMP4C` writer - Master Compare 4 Interrupt flag clear"]
pub type MCMP4C_W<'a, const O: u8> = crate::BitWriter<'a, MICR_SPEC, O>;
#[doc = "Field `MREPC` writer - Repetition Interrupt flag clear"]
pub type MREPC_W<'a, const O: u8> = crate::BitWriter<'a, MICR_SPEC, O>;
#[doc = "Field `SYNCC` writer - Sync Input Interrupt flag clear"]
pub type SYNCC_W<'a, const O: u8> = crate::BitWriter<'a, MICR_SPEC, O>;
#[doc = "Field `MUPDC` writer - Master update Interrupt flag clear"]
pub type MUPDC_W<'a, const O: u8> = crate::BitWriter<'a, MICR_SPEC, O>;
impl W {
